# React.js Interview Questions & Answers — The Complete Reference

*A unified, deduplicated collection of 758 React.js interview questions and answers, merged from multiple source collections and organized by topic. Click any question in the Table of Contents to jump straight to its answer.*
...
1. [Can you use React without JSX?](#1-can-you-use-react-without-jsx)
2. [How can we find the version of React at runtime in the browser?](#2-how-can-we-find-the-version-of-react-at-runtime-in-the-browser)
3. [How do you apply vendor prefixes to inline styles in React?](#3-how-do-you-apply-vendor-prefixes-to-inline-styles-in-react)
4. [How do you print falsy values in JSX?](#4-how-do-you-print-falsy-values-in-jsx)
5. [How events are different in React?](#5-how-events-are-different-in-react)
6. [How is the new JSX transform different from old transform??](#6-how-is-the-new-jsx-transform-different-from-old-transform)
7. [How JSX prevents Injection Attacks?](#7-how-jsx-prevents-injection-attacks)
8. [How to pass a parameter to an event handler or callback?](#8-how-to-pass-a-parameter-to-an-event-handler-or-callback)
9. [How to programmatically trigger click event in React?](#9-how-to-programmatically-trigger-click-event-in-react)
10. [How to use React label element?](#10-how-to-use-react-label-element)
11. [How to write comments in React?](#11-how-to-write-comments-in-react)
12. [Is it possible to use React without rendering HTML?](#12-is-it-possible-to-use-react-without-rendering-html)
13. [What are the possible return types of render method?](#13-what-are-the-possible-return-types-of-render-method)
14. [What is React Query's caching model?](#14-what-is-react-querys-caching-model)
15. [What is the difference between createElement and cloneElement?](#15-what-is-the-difference-between-createelement-and-cloneelement)
16. [What is the difference between HTML and React event handling?](#16-what-is-the-difference-between-html-and-react-event-handling)
17. [What is the reason behind multiple JSX tags to be wrapped?](#17-what-is-the-reason-behind-multiple-jsx-tags-to-be-wrapped)
18. [Why React uses `className` over `class` attribute?](#18-why-react-uses-classname-over-class-attribute)

### Components, Props & State

19. [Can I dispatch an action in reducer?](#19-can-i-dispatch-an-action-in-reducer)
20. [Can I import an SVG file as react component?](#20-can-i-import-an-svg-file-as-react-component)
21. [Can I use keys for non-list items?](#21-can-i-use-keys-for-non-list-items)
22. [Can I use web components in react application?](#22-can-i-use-web-components-in-react-application)
23. [Describe about data flow in react?](#23-describe-about-data-flow-in-react)
24. [Does React support all HTML attributes?](#24-does-react-support-all-html-attributes)
25. [Does the statics object work with ES6 classes in React?](#25-does-the-statics-object-work-with-es6-classes-in-react)
26. [Explain React state and props.](#26-explain-react-state-and-props)
27. [How do you access imperative API of web components?](#27-how-do-you-access-imperative-api-of-web-components)
28. [How do you access props in attribute quotes?](#28-how-do-you-access-props-in-attribute-quotes)
29. [How do you conditionally render components?](#29-how-do-you-conditionally-render-components)
30. [How do you prevent mutating array variables?](#30-how-do-you-prevent-mutating-array-variables)
31. [How do you protect routes (auth guards)?](#31-how-do-you-protect-routes-auth-guards)
32. [How do you say that props are read only?](#32-how-do-you-say-that-props-are-read-only)
33. [How do you say that props are readonly?](#33-how-do-you-say-that-props-are-readonly)
34. [How do you say that state updates are merged?](#34-how-do-you-say-that-state-updates-are-merged)
35. [How do you test components with context?](#35-how-do-you-test-components-with-context)
36. [How do you update objects inside state?](#36-how-do-you-update-objects-inside-state)
37. [How does React updates screen in an application?](#37-how-does-react-updates-screen-in-an-application)
38. [How does useLayoutEffect cause layout thrashing?](#38-how-does-uselayouteffect-cause-layout-thrashing)
39. [How React PropTypes allow different types for one prop?](#39-how-react-proptypes-allow-different-types-for-one-prop)
40. [How to access current locale with React Intl?](#40-how-to-access-current-locale-with-react-intl)
41. [How to apply validation on props in React?](#41-how-to-apply-validation-on-props-in-react)
42. [How to bind methods or event handlers in JSX callbacks?](#42-how-to-bind-methods-or-event-handlers-in-jsx-callbacks)
43. [How to conditionally apply class attributes?](#43-how-to-conditionally-apply-class-attributes)
44. [How to create a switching component for displaying different pages?](#44-how-to-create-a-switching-component-for-displaying-different-pages)
45. [How to create components in React?](#45-how-to-create-components-in-react)
46. [How to create react class components without ES6?](#46-how-to-create-react-class-components-without-es6)
47. [How to create refs?](#47-how-to-create-refs)
48. [How to define constants in React?](#48-how-to-define-constants-in-react)
49. [How to import and export components using React and ES6?](#49-how-to-import-and-export-components-using-react-and-es6)
50. [How to pass numbers to React component?](#50-how-to-pass-numbers-to-react-component)
51. [How to prevent component from rendering?](#51-how-to-prevent-component-from-rendering)
52. [How to use class field declarations syntax in React classes?](#52-how-to-use-class-field-declarations-syntax-in-react-classes)
53. [How to use Font Awesome icons in React?](#53-how-to-use-font-awesome-icons-in-react)
54. [How to use Polymer in React?](#54-how-to-use-polymer-in-react)
55. [How you use decorators in React?](#55-how-you-use-decorators-in-react)
56. [Is it good to use arrow functions in render methods?](#56-is-it-good-to-use-arrow-functions-in-render-methods)
57. [Is it mandatory to define constructor for React component?](#57-is-it-mandatory-to-define-constructor-for-react-component)
58. [Is it possible to use react without JSX?](#58-is-it-possible-to-use-react-without-jsx)
59. [Is ref argument available for all functions or class components?](#59-is-ref-argument-available-for-all-functions-or-class-components)
60. [Is that possible to use useImperativeHandle without forwardRef?](#60-is-that-possible-to-use-useimperativehandle-without-forwardref)
61. [Render order of nested Parent → Child → GrandChild components](#61-render-order-of-nested-parent-child-grandchild-components)
62. [Situation: Two components on different branches need the same data – what do you do?](#62-situation-two-components-on-different-branches-need-the-same-data-what-do-you-do)
63. [What are default props?](#63-what-are-default-props)
64. [What are forward refs?](#64-what-are-forward-refs)
65. [What are fragments?](#65-what-are-fragments)
66. [What are inline conditional expressions?](#66-what-are-inline-conditional-expressions)
67. [What are portals in React?](#67-what-are-portals-in-react)
68. [What are props in React?](#68-what-are-props-in-react)
69. [What are React elements vs React components?](#69-what-are-react-elements-vs-react-components)
70. [What are React Portals, and when would you use them?](#70-what-are-react-portals-and-when-would-you-use-them)
71. [What are synthetic events in React?](#71-what-are-synthetic-events-in-react)
72. [What are the benefits of preventing the direct state mutations?](#72-what-are-the-benefits-of-preventing-the-direct-state-mutations)
73. [What are the different ways to style a React component?](#73-what-are-the-different-ways-to-style-a-react-component)
74. [What are the exceptions on React component naming?](#74-what-are-the-exceptions-on-react-component-naming)
75. [What are the guidelines to be followed for writing reducers?](#75-what-are-the-guidelines-to-be-followed-for-writing-reducers)
76. [What are the possible ways of updating objects in state?](#76-what-are-the-possible-ways-of-updating-objects-in-state)
77. [What are the preferred and non-preferred array operations for updating the state?](#77-what-are-the-preferred-and-non-preferred-array-operations-for-updating-the-state)
78. [What are the rules of JSX?](#78-what-are-the-rules-of-jsx)
79. [What does JSX compile to?](#79-what-does-jsx-compile-to)
80. [What is `forwardRef`?](#80-what-is-forwardref)
81. [What is a consumer?](#81-what-is-a-consumer)
82. [What is a React component?](#82-what-is-a-react-component)
83. [What is a switching component?](#83-what-is-a-switching-component)
84. [What is a wrapper component?](#84-what-is-a-wrapper-component)
85. [What is an updater function? Should an updater function be used in all cases?](#85-what-is-an-updater-function-should-an-updater-function-be-used-in-all-cases)
86. [What is children prop?](#86-what-is-children-prop)
87. [What is colocation in React?](#87-what-is-colocation-in-react)
88. [What is forwardRef, and when do you need it?](#88-what-is-forwardref-and-when-do-you-need-it)
89. [What is HMR (Hot Module Replacement)?](#89-what-is-hmr-hot-module-replacement)
90. [What is JSX and why does React use it?](#90-what-is-jsx-and-why-does-react-use-it)
91. [What is JSX?](#91-what-is-jsx)
92. [What is Lifting State Up in React?](#92-what-is-lifting-state-up-in-react)
93. [What is prop inversion of control?](#93-what-is-prop-inversion-of-control)
94. [What is React proptype array with shape?](#94-what-is-react-proptype-array-with-shape)
95. [What is React.Fragment and why is it useful?](#95-what-is-reactfragment-and-why-is-it-useful)
96. [What is server state vs client state?](#96-what-is-server-state-vs-client-state)
97. [What is state mutation and how to prevent it?](#97-what-is-state-mutation-and-how-to-prevent-it)
98. [What is the benefit of styles modules?](#98-what-is-the-benefit-of-styles-modules)
99. [What is the difference between `setState()` and `replaceState()` methods?](#99-what-is-the-difference-between-setstate-and-replacestate-methods)
100. [What is the difference between `super()` and `super(props)` in React using ES6 classes?](#100-what-is-the-difference-between-super-and-superprops-in-react-using-es6-classes)
101. [What is the difference between an Element and a Component?](#101-what-is-the-difference-between-an-element-and-a-component)
102. [What is the difference between constructor and getInitialState?](#102-what-is-the-difference-between-constructor-and-getinitialstate)
103. [What is the difference between Flow and PropTypes?](#103-what-is-the-difference-between-flow-and-proptypes)
104. [What is the difference between Imperative and Declarative in React?](#104-what-is-the-difference-between-imperative-and-declarative-in-react)
105. [What is the difference between try catch block and error boundaries?](#105-what-is-the-difference-between-try-catch-block-and-error-boundaries)
106. [What is the main purpose of constructor?](#106-what-is-the-main-purpose-of-constructor)
107. [What is the purpose of render method of `react-dom`?](#107-what-is-the-purpose-of-render-method-of-react-dom)
108. [What is the purpose of unmountComponentAtNode method?](#108-what-is-the-purpose-of-unmountcomponentatnode-method)
109. [What is the purpose of using super constructor with props argument?](#109-what-is-the-purpose-of-using-super-constructor-with-props-argument)
110. [What is the recommended approach of removing an array element in React state?](#110-what-is-the-recommended-approach-of-removing-an-array-element-in-react-state)
111. [What is the recommended way for naming components?](#111-what-is-the-recommended-way-for-naming-components)
112. [What is the required method to be defined for a class component?](#112-what-is-the-required-method-to-be-defined-for-a-class-component)
113. [What is the typical use case of portals?](#113-what-is-the-typical-use-case-of-portals)
114. [What is the use of refs?](#114-what-is-the-use-of-refs)
115. [What will happen by defining nested function components?](#115-what-will-happen-by-defining-nested-function-components)
116. [What will happen if you use props in initial state?](#116-what-will-happen-if-you-use-props-in-initial-state)
117. [What would be the common mistake of function being called every time the component renders?](#117-what-would-be-the-common-mistake-of-function-being-called-every-time-the-component-renders)
118. [When component props defaults to true?](#118-when-component-props-defaults-to-true)
119. [When should a component be split into smaller components?](#119-when-should-a-component-be-split-into-smaller-components)
120. [Why are inline ref callbacks or functions not recommended?](#120-why-are-inline-ref-callbacks-or-functions-not-recommended)
121. [Why are keys important in lists? What happens if keys are unstable?](#121-why-are-keys-important-in-lists-what-happens-if-keys-are-unstable)
122. [Why are String Refs legacy?](#122-why-are-string-refs-legacy)
123. [Why can't you update props in React?](#123-why-cant-you-update-props-in-react)
124. [Why do you not required to use inheritance?](#124-why-do-you-not-required-to-use-inheritance)
125. [Why is `isMounted()` an anti-pattern and what is the proper solution?](#125-why-is-ismounted-an-anti-pattern-and-what-is-the-proper-solution)
126. [Why should component names start with capital letter?](#126-why-should-component-names-start-with-capital-letter)
127. [Why we need to be careful when spreading props on DOM elements?](#127-why-we-need-to-be-careful-when-spreading-props-on-dom-elements)
128. [Why we need to pass a function to setState()?](#128-why-we-need-to-pass-a-function-to-setstate)

### Core Hooks (useState, useEffect, useRef, useContext)

129. [Build a custom hook like `useDebounce` or `useFetch`.](#129-build-a-custom-hook-like-usedebounce-or-usefetch)
130. [Calling a hook conditionally inside an if block](#130-calling-a-hook-conditionally-inside-an-if-block)
131. [Can Hooks be used in class components?](#131-can-hooks-be-used-in-class-components)
132. [Can useState take a function as an initial value?](#132-can-usestate-take-a-function-as-an-initial-value)
133. [Can you dispatch multiple actions in a row with useReducer?](#133-can-you-dispatch-multiple-actions-in-a-row-with-usereducer)
134. [Can you explain how useState works internally?](#134-can-you-explain-how-usestate-works-internally)
135. [Can you have multiple useEffect hooks in a single component?](#135-can-you-have-multiple-useeffect-hooks-in-a-single-component)
136. [Design a form wizard with multiple steps in React.](#136-design-a-form-wizard-with-multiple-steps-in-react)
137. [Differentiate React Hooks vs Classes.](#137-differentiate-react-hooks-vs-classes)
138. [Do I need to rewrite all my class components with hooks?](#138-do-i-need-to-rewrite-all-my-class-components-with-hooks)
139. [Does React Hook work with static typing?](#139-does-react-hook-work-with-static-typing)
140. [Event bubbling through a React portal rendered outside the DOM parent](#140-event-bubbling-through-a-react-portal-rendered-outside-the-dom-parent)
141. [Explain about types of side effects in React component.](#141-explain-about-types-of-side-effects-in-react-component)
142. [Explain how to create a simple React Hooks example program.](#142-explain-how-to-create-a-simple-react-hooks-example-program)
143. [Explain React Hooks.](#143-explain-react-hooks)
144. [Explain useEffect deeply — cleanup, dependency array pitfalls.](#144-explain-useeffect-deeply-cleanup-dependency-array-pitfalls)
145. [Functional update vs direct update](#145-functional-update-vs-direct-update)
146. [How do reactive dependencies in the useEffect dependency array affect its execution behavior?](#146-how-do-reactive-dependencies-in-the-useeffect-dependency-array-affect-its-execution-behavior)
147. [How do you create a custom hook?](#147-how-do-you-create-a-custom-hook)
148. [How do you handle cleanup in useEffect?](#148-how-do-you-handle-cleanup-in-useeffect)
149. [How do you handle errors in `useEffect`?](#149-how-do-you-handle-errors-in-useeffect)
150. [How do you manage focus after navigation in a SPA?](#150-how-do-you-manage-focus-after-navigation-in-a-spa)
151. [How do you share state logic between components using custom hooks?](#151-how-do-you-share-state-logic-between-components-using-custom-hooks)
152. [How do you type `useRef`?](#152-how-do-you-type-useref)
153. [How Do You Use useRef to Access a DOM Element in React? Give an example.](#153-how-do-you-use-useref-to-access-a-dom-element-in-react-give-an-example)
154. [How is `useReducer` Different from `useState`?](#154-how-is-usereducer-different-from-usestate)
155. [How to listen to state changes?](#155-how-to-listen-to-state-changes)
156. [How to pass data between react components?](#156-how-to-pass-data-between-react-components)
157. [How to prevent infinite loops with useEffect?](#157-how-to-prevent-infinite-loops-with-useeffect)
158. [How to update a component every second?](#158-how-to-update-a-component-every-second)
159. [How would you handle real-time data updates (live prices, scores)?](#159-how-would-you-handle-real-time-data-updates-live-prices-scores)
160. [How would you migrate a large class-based codebase to hooks?](#160-how-would-you-migrate-a-large-class-based-codebase-to-hooks)
161. [Is it possible to access a ref in the render method?](#161-is-it-possible-to-access-a-ref-in-the-render-method)
162. [Is useState Synchronous or Asynchronous?](#162-is-usestate-synchronous-or-asynchronous)
163. [Multiple setState calls in one handler](#163-multiple-setstate-calls-in-one-handler)
164. [Multiple useEffects order](#164-multiple-useeffects-order)
165. [Order of setState calls, componentDidMount and componentDidUpdate in a class component](#165-order-of-setstate-calls-componentdidmount-and-componentdidupdate-in-a-class-component)
166. [Stale closure in useEffect](#166-stale-closure-in-useeffect)
167. [State update is asynchronous](#167-state-update-is-asynchronous)
168. [Two components using the same custom hook — do they share state?](#168-two-components-using-the-same-custom-hook-do-they-share-state)
169. [useEffect cleanup timing](#169-useeffect-cleanup-timing)
170. [useEffect mount/unmount order when toggling between two sibling components](#170-useeffect-mountunmount-order-when-toggling-between-two-sibling-components)
171. [useEffect vs useLayoutEffect timing](#171-useeffect-vs-uselayouteffect-timing)
172. [useEffect with async function](#172-useeffect-with-async-function)
173. [useEffect with empty dependency array](#173-useeffect-with-empty-dependency-array)
174. [useReducer vs useState for complex state](#174-usereducer-vs-usestate-for-complex-state)
175. [useRef to track previous value](#175-useref-to-track-previous-value)
176. [What are Custom React Hooks, and How Can You Develop One?](#176-what-are-custom-react-hooks-and-how-can-you-develop-one)
177. [What are presentational vs container components?](#177-what-are-presentational-vs-container-components)
178. [What are stale closures in `useEffect`?](#178-what-are-stale-closures-in-useeffect)
179. [What are stateful components?](#179-what-are-stateful-components)
180. [What are stateless components?](#180-what-are-stateless-components)
181. [What are the differences between functional and class components?](#181-what-are-the-differences-between-functional-and-class-components)
182. [What are the different phases of component lifecycle?](#182-what-are-the-different-phases-of-component-lifecycle)
183. [What are the lifecycle methods going to be deprecated in React v16?](#183-what-are-the-lifecycle-methods-going-to-be-deprecated-in-react-v16)
184. [What are the lifecycle methods of React?](#184-what-are-the-lifecycle-methods-of-react)
185. [What are the rules needs to follow for hooks?](#185-what-are-the-rules-needs-to-follow-for-hooks)
186. [What are the Rules of Hooks?](#186-what-are-the-rules-of-hooks)
187. [What happens if you call `useState` conditionally?](#187-what-happens-if-you-call-usestate-conditionally)
188. [What happens if you return a Promise from useEffect??](#188-what-happens-if-you-return-a-promise-from-useeffect)
189. [What is `getSnapshotBeforeUpdate`?](#189-what-is-getsnapshotbeforeupdate)
190. [What is `useEffect`?](#190-what-is-useeffect)
191. [What is `useLayoutEffect`?](#191-what-is-uselayouteffect)
192. [What is lazy initialization in `useState`?](#192-what-is-lazy-initialization-in-usestate)
193. [What is SWR?](#193-what-is-swr)
194. [What is the `useEffect` cleanup function?](#194-what-is-the-useeffect-cleanup-function)
195. [What is the container/presenter pattern and is it still relevant?](#195-what-is-the-containerpresenter-pattern-and-is-it-still-relevant)
196. [What is the difference between useEffect and useLayoutEffect?](#196-what-is-the-difference-between-useeffect-and-uselayouteffect)
197. [What is the lifecycle methods order in mounting?](#197-what-is-the-lifecycle-methods-order-in-mounting)
198. [What is the order of hook execution in a component?](#198-what-is-the-order-of-hook-execution-in-a-component)
199. [What is the recommended ordering of methods in component class?](#199-what-is-the-recommended-ordering-of-methods-in-component-class)
200. [What is the use of useEffect React Hooks?](#200-what-is-the-use-of-useeffect-react-hooks)
201. [What is useEffect hook? How to fetch data with React Hooks?](#201-what-is-useeffect-hook-how-to-fetch-data-with-react-hooks)
202. [What is useImperativeHandle Hook? Give an example.](#202-what-is-useimperativehandle-hook-give-an-example)
203. [What is useReducer, and when would you use it over useState?](#203-what-is-usereducer-and-when-would-you-use-it-over-usestate)
204. [What is useState() in React?](#204-what-is-usestate-in-react)
205. [What rules need to be followed for hooks?](#205-what-rules-need-to-be-followed-for-hooks)
206. [When and how often does React invoke the setup and cleanup functions inside a useEffect hook?](#206-when-and-how-often-does-react-invoke-the-setup-and-cleanup-functions-inside-a-useeffect-hook)
207. [When does a child's useEffect cleanup run vs the parent's cleanup?](#207-when-does-a-childs-useeffect-cleanup-run-vs-the-parents-cleanup)
208. [When should you use useImperativeHandle?](#208-when-should-you-use-useimperativehandle)
209. [When to use a Class Component over a Function Component?](#209-when-to-use-a-class-component-over-a-function-component)
210. [Which is preferred option with in callback refs and findDOMNode()?](#210-which-is-preferred-option-with-in-callback-refs-and-finddomnode)
211. [Why do we use array destructuring (square brackets notation) in `useState`?](#211-why-do-we-use-array-destructuring-square-brackets-notation-in-usestate)
212. [Why do you not need error boundaries for event handlers?](#212-why-do-you-not-need-error-boundaries-for-event-handlers)
213. [Why should not call setState in componentWillUnmount?](#213-why-should-not-call-setstate-in-componentwillunmount)
214. [Why use functional updates with `useState`?](#214-why-use-functional-updates-with-usestate)

### Performance Hooks & Memoization (useMemo, useCallback, React.memo)

215. [`useMemo` vs `useCallback` – what's the difference?](#215-usememo-vs-usecallback-whats-the-difference)
216. [A React component re-renders again and again but you never called setState. Why?](#216-a-react-component-re-renders-again-and-again-but-you-never-called-setstate-why)
217. [Can useRef be used to store previous values?](#217-can-useref-be-used-to-store-previous-values)
218. [Can you describe the useMemo() Hook?](#218-can-you-describe-the-usememo-hook)
219. [Can you force a component to re-render without calling setState?](#219-can-you-force-a-component-to-re-render-without-calling-setstate)
220. [Can you use useRef to persist values across renders??](#220-can-you-use-useref-to-persist-values-across-renders)
221. [Child re-render when parent re-renders](#221-child-re-render-when-parent-re-renders)
222. [Context re-render behavior – what should you know?](#222-context-re-render-behavior-what-should-you-know)
223. [Context value change causing child re-render (and same-value updates)](#223-context-value-change-causing-child-re-render-and-same-value-updates)
224. [Context value change re-renders all consumers](#224-context-value-change-re-renders-all-consumers)
225. [Controlled vs uncontrolled forms – trade-offs in practice?](#225-controlled-vs-uncontrolled-forms-trade-offs-in-practice)
226. [Defining a child component inside a parent's render function](#226-defining-a-child-component-inside-a-parents-render-function)
227. [Does the lazy function support named exports?](#227-does-the-lazy-function-support-named-exports)
228. [Does useMemo prevent re-rendering of child components?](#228-does-usememo-prevent-re-rendering-of-child-components)
229. [Explain the concept of "controlled re‑render boundaries".](#229-explain-the-concept-of-controlled-rerender-boundaries)
230. [Force-updating a component after mutating a ref directly](#230-force-updating-a-component-after-mutating-a-ref-directly)
231. [How do you avoid unnecessary object/function recreation?](#231-how-do-you-avoid-unnecessary-objectfunction-recreation)
232. [How do you handle real-time updates efficiently in React?](#232-how-do-you-handle-real-time-updates-efficiently-in-react)
233. [How do you solve performance corner cases while using context?](#233-how-do-you-solve-performance-corner-cases-while-using-context)
234. [How does `useRef` differ from a regular variable?](#234-how-does-useref-differ-from-a-regular-variable)
235. [How does React batch multiple state updates?](#235-how-does-react-batch-multiple-state-updates)
236. [How to prevent re-renders in React?](#236-how-to-prevent-re-renders-in-react)
237. [How to prevent unnecessary updates using setState?](#237-how-to-prevent-unnecessary-updates-using-setstate)
238. [How to re-render the view when the browser is resized?](#238-how-to-re-render-the-view-when-the-browser-is-resized)
239. [How would you implement infinite scroll?](#239-how-would-you-implement-infinite-scroll)
240. [How would you optimize a React application rendering 100,000+ items in a list?](#240-how-would-you-optimize-a-react-application-rendering-100000-items-in-a-list)
241. [If we have var, let, and const, why do we need state variables?](#241-if-we-have-var-let-and-const-why-do-we-need-state-variables)
242. [Is dispatch from useReducer asynchronous and does it update state immediately?](#242-is-dispatch-from-usereducer-asynchronous-and-does-it-update-state-immediately)
243. [Map class lifecycle methods to hooks.](#243-map-class-lifecycle-methods-to-hooks)
244. [Name a few techniques to optimize React app performance.](#244-name-a-few-techniques-to-optimize-react-app-performance)
245. [Object state partial update](#245-object-state-partial-update)
246. [Re-render on same state value](#246-re-render-on-same-state-value)
247. [React.memo with object prop](#247-reactmemo-with-object-prop)
248. [React.useMemo() memoizing a JSX element to skip a child's re-render](#248-reactusememo-memoizing-a-jsx-element-to-skip-a-childs-re-render)
249. [Scenario: Context API causes frequent re‑renders – why and how to fix?](#249-scenario-context-api-causes-frequent-rerenders-why-and-how-to-fix)
250. [Situation: `useEffect` runs infinitely – what's wrong?](#250-situation-useeffect-runs-infinitely-whats-wrong)
251. [State mutation directly](#251-state-mutation-directly)
252. [useCallback returning a stable function reference across re-renders](#252-usecallback-returning-a-stable-function-reference-across-re-renders)
253. [useCallback without dependency change](#253-usecallback-without-dependency-change)
254. [useEffect infinite loop](#254-useeffect-infinite-loop)
255. [useMemo recalculation](#255-usememo-recalculation)
256. [useMemo recomputing when a dependency array value is a new array reference each render](#256-usememo-recomputing-when-a-dependency-array-value-is-a-new-array-reference-each-render)
257. [useRef does not cause re-render](#257-useref-does-not-cause-re-render)
258. [What are common React performance optimization techniques? (practical guide)](#258-what-are-common-react-performance-optimization-techniques-practical-guide)
259. [What are Pure Components?](#259-what-are-pure-components)
260. [What are React Mixins?](#260-what-are-react-mixins)
261. [What are the benefits of new JSX transform?](#261-what-are-the-benefits-of-new-jsx-transform)
262. [What are the differences between useEffect and useEvent (experimental)?](#262-what-are-the-differences-between-useeffect-and-useevent-experimental)
263. [What are the hidden reasons a component re‑renders even when props don't change?](#263-what-are-the-hidden-reasons-a-component-rerenders-even-when-props-dont-change)
264. [What are the three main lifecycle phases?](#264-what-are-the-three-main-lifecycle-phases)
265. [What causes unnecessary re-renders in React?](#265-what-causes-unnecessary-re-renders-in-react)
266. [What does 'declarative' mean in React?](#266-what-does-declarative-mean-in-react)
267. [What happens if a child uses React.memo() and parent props don't change?](#267-what-happens-if-a-child-uses-reactmemo-and-parent-props-dont-change)
268. [What happens if a component wrapped in `memo()` has its own state changes?](#268-what-happens-if-a-component-wrapped-in-memo-has-its-own-state-changes)
269. [What happens if you mutate state directly?](#269-what-happens-if-you-mutate-state-directly)
270. [What happens when a parent re-renders?](#270-what-happens-when-a-parent-re-renders)
271. [What is `getDerivedStateFromProps` and when would you use it?](#271-what-is-getderivedstatefromprops-and-when-would-you-use-it)
272. [What is `shouldComponentUpdate` and its functional equivalent?](#272-what-is-shouldcomponentupdate-and-its-functional-equivalent)
273. [What is `useCallback` and why is it used?](#273-what-is-usecallback-and-why-is-it-used)
274. [What is `useContext`?](#274-what-is-usecontext)
275. [What is `useMemo`?](#275-what-is-usememo)
276. [What is `useRef`?](#276-what-is-useref)
277. [What is a hook?](#277-what-is-a-hook)
278. [What is React Hook Form and why is it popular?](#278-what-is-react-hook-form-and-why-is-it-popular)
279. [What is React lazy function?](#279-what-is-react-lazy-function)
280. [What is React memo function?](#280-what-is-react-memo-function)
281. [What is React.memo? How is it different from useMemo and useCallback?](#281-what-is-reactmemo-how-is-it-different-from-usememo-and-usecallback)
282. [What is state in React?](#282-what-is-state-in-react)
283. [What is the difference between element and component re-render?](#283-what-is-the-difference-between-element-and-component-re-render)
284. [What is the difference between useMemo and useCallback?](#284-what-is-the-difference-between-usememo-and-usecallback)
285. [What is the difference between useState and useRef hook?](#285-what-is-the-difference-between-usestate-and-useref-hook)
286. [What is the methods order when component re-rendered?](#286-what-is-the-methods-order-when-component-re-rendered)
287. [What is the purpose of `getDerivedStateFromProps()` lifecycle method?](#287-what-is-the-purpose-of-getderivedstatefromprops-lifecycle-method)
288. [What is the purpose of callback function as an argument of `setState()`?](#288-what-is-the-purpose-of-callback-function-as-an-argument-of-setstate)
289. [What is the React Compiler (React Forget)?](#289-what-is-the-react-compiler-react-forget)
290. [What problems does `useMemo` actually solve? When should you NOT use it?](#290-what-problems-does-usememo-actually-solve-when-should-you-not-use-it)
291. [What types of values can `useState` hold?](#291-what-types-of-values-can-usestate-hold)
292. [What will happen if you use `setState()` in constructor?](#292-what-will-happen-if-you-use-setstate-in-constructor)
293. [What's a common pitfall when using useContext with objects?](#293-whats-a-common-pitfall-when-using-usecontext-with-objects)
294. [When does `React.memo` NOT help?](#294-when-does-reactmemo-not-help)
295. [When would you use `React.memo`?](#295-when-would-you-use-reactmemo)
296. [Why should we not update the state directly?](#296-why-should-we-not-update-the-state-directly)

### Custom Hooks & Hands-On Coding

297. [Build a controlled form with validation (email, password strength)](#297-build-a-controlled-form-with-validation-email-password-strength)
298. [Build a counter that increments and decrements](#298-build-a-counter-that-increments-and-decrements)
299. [Build a data grid/table with sort, filter, and pagination](#299-build-a-data-gridtable-with-sort-filter-and-pagination)
300. [Build a drag-and-drop list (without libraries)](#300-build-a-drag-and-drop-list-without-libraries)
301. [Build a file upload component with drag-and-drop, progress, and preview](#301-build-a-file-upload-component-with-drag-and-drop-progress-and-preview)
302. [Build a Kanban board with columns and drag-and-drop cards](#302-build-a-kanban-board-with-columns-and-drag-and-drop-cards)
303. [Build a Modal with focus trap and Escape key to close](#303-build-a-modal-with-focus-trap-and-escape-key-to-close)
304. [Build a multi-step form wizard with Next/Back navigation and validation](#304-build-a-multi-step-form-wizard-with-nextback-navigation-and-validation)
305. [Build a search input with debouncing that fetches from an API](#305-build-a-search-input-with-debouncing-that-fetches-from-an-api)
306. [Build a Star Rating component](#306-build-a-star-rating-component)
307. [Build a Todo App (CRUD + filter + localStorage persistence)](#307-build-a-todo-app-crud-filter-localstorage-persistence)
308. [Build a tree view (expandable/collapsible nodes)](#308-build-a-tree-view-expandablecollapsible-nodes)
309. [Build a typeahead / autocomplete component with keyboard navigation](#309-build-a-typeahead-autocomplete-component-with-keyboard-navigation)
310. [Build an Accordion (single/multi open behavior)](#310-build-an-accordion-singlemulti-open-behavior)
311. [Build tabs with lazy-loaded content](#311-build-tabs-with-lazy-loaded-content)
312. [Implement a carousel/image slider](#312-implement-a-carouselimage-slider)
313. [Implement a custom `useAsync` hook (manage async function states)](#313-implement-a-custom-useasync-hook-manage-async-function-states)
314. [Implement a custom `useClickOutside` hook](#314-implement-a-custom-useclickoutside-hook)
315. [Implement a custom `useDebounce` hook](#315-implement-a-custom-usedebounce-hook)
316. [Implement a custom `useEventListener` hook](#316-implement-a-custom-useeventlistener-hook)
317. [Implement a custom `useFetch` hook (loading/error/data states)](#317-implement-a-custom-usefetch-hook-loadingerrordata-states)
318. [Implement a custom `useIntersectionObserver` hook](#318-implement-a-custom-useintersectionobserver-hook)
319. [Implement a custom `useLocalStorage` hook](#319-implement-a-custom-uselocalstorage-hook)
320. [Implement a custom `useMediaQuery` hook](#320-implement-a-custom-usemediaquery-hook)
321. [Implement a custom `usePrevious` hook (returns previous state value)](#321-implement-a-custom-useprevious-hook-returns-previous-state-value)
322. [Implement a custom `useThrottle` hook](#322-implement-a-custom-usethrottle-hook)
323. [Implement a custom `useWindowSize` hook](#323-implement-a-custom-usewindowsize-hook)
324. [Implement a recursive comment thread (nested comments with reply)](#324-implement-a-recursive-comment-thread-nested-comments-with-reply)
325. [Implement a virtualized list (render only visible rows)](#325-implement-a-virtualized-list-render-only-visible-rows)
326. [Implement pagination (client-side and server-side)](#326-implement-pagination-client-side-and-server-side)
327. [What is `flushSync`? When would you use it?](#327-what-is-flushsync-when-would-you-use-it)
328. [What is the `use server` directive (Next.js Server Actions)?](#328-what-is-the-use-server-directive-nextjs-server-actions)

### Rendering, Virtual DOM & Reconciliation

329. [How Virtual DOM works?](#329-how-virtual-dom-works)
330. [What are the advantages of using React?](#330-what-are-the-advantages-of-using-react)
331. [What is event delegation in React?](#331-what-is-event-delegation-in-react)
332. [What is React Fiber?](#332-what-is-react-fiber)
333. [What is the difference between Real DOM and Virtual DOM?](#333-what-is-the-difference-between-real-dom-and-virtual-dom)
334. [What is the main goal of React Fiber?](#334-what-is-the-main-goal-of-react-fiber)

### Lists, Keys & Conditional Rendering

335. [Explain conditional rendering in React.](#335-explain-conditional-rendering-in-react)
336. [Explain the commit phase vs render phase.](#336-explain-the-commit-phase-vs-render-phase)
337. [How do you implement a feature flag system?](#337-how-do-you-implement-a-feature-flag-system)
338. [How do you render Array, Strings and Numbers in React 16 Version?](#338-how-do-you-render-array-strings-and-numbers-in-react-16-version)
339. [How does the Virtual DOM improve performance?](#339-how-does-the-virtual-dom-improve-performance)
340. [How to loop inside JSX?](#340-how-to-loop-inside-jsx)
341. [How would you implement role-based access control (RBAC) in React?](#341-how-would-you-implement-role-based-access-control-rbac-in-react)
342. [Index as key with reorder](#342-index-as-key-with-reorder)
343. [Key change forcing remount](#343-key-change-forcing-remount)
344. [Missing key prop behavior](#344-missing-key-prop-behavior)
345. [Should keys be globally unique?](#345-should-keys-be-globally-unique)
346. [What are Keyed Fragments?](#346-what-are-keyed-fragments)
347. [What are keys in React?](#347-what-are-keys-in-react)
348. [What are the rules covered by diffing algorithm?](#348-what-are-the-rules-covered-by-diffing-algorithm)
349. [What is "key" prop and what is the benefit of using it in arrays of elements?](#349-what-is-key-prop-and-what-is-the-benefit-of-using-it-in-arrays-of-elements)
350. [What is diffing algorithm?](#350-what-is-diffing-algorithm)
351. [What is reconciliation?](#351-what-is-reconciliation)
352. [What is reconciliation? How does React's diffing algorithm work?](#352-what-is-reconciliation-how-does-reacts-diffing-algorithm-work)
353. [What is the `key` prop and why is it important?](#353-what-is-the-key-prop-and-why-is-it-important)
354. [What is the impact of indexes as keys?](#354-what-is-the-impact-of-indexes-as-keys)
355. [Why is a component constructor called only once?](#355-why-is-a-component-constructor-called-only-once)

### Forms & Controlled Components

356. [How do you set default value for uncontrolled component?](#356-how-do-you-set-default-value-for-uncontrolled-component)
357. [How to focus an input element on page load?](#357-how-to-focus-an-input-element-on-page-load)
358. [List reorder with stable key vs index key — where does uncontrolled input value go?](#358-list-reorder-with-stable-key-vs-index-key-where-does-uncontrolled-input-value-go)
359. [What are the differences between controlled and uncontrolled components?](#359-what-are-the-differences-between-controlled-and-uncontrolled-components)
360. [What is the controlled component pattern for reusable components?](#360-what-is-the-controlled-component-pattern-for-reusable-components)

### Context API & Prop Drilling

361. [Can You Use Multiple Contexts in One Component?](#361-can-you-use-multiple-contexts-in-one-component)
362. [Explain about types of Hooks in React.](#362-explain-about-types-of-hooks-in-react)
363. [Give an example on How to use context?](#363-give-an-example-on-how-to-use-context)
364. [How do you type context?](#364-how-do-you-type-context)
365. [How do you use contextType?](#365-how-do-you-use-contexttype)
366. [How does React Context work? When can it hurt performance?](#366-how-does-react-context-work-when-can-it-hurt-performance)
367. [How does useContext works? Explain with an example](#367-how-does-usecontext-works-explain-with-an-example)
368. [What is `useFormStatus`?](#368-what-is-useformstatus)
369. [What is context?](#369-what-is-context)
370. [What is the Context API?](#370-what-is-the-context-api)
371. [What is the Context API? When should you use it instead of prop drilling?](#371-what-is-the-context-api-when-should-you-use-it-instead-of-prop-drilling)
372. [What is the purpose of default value in context?](#372-what-is-the-purpose-of-default-value-in-context)
373. [What is useContext? What are the steps to follow for useContext?](#373-what-is-usecontext-what-are-the-steps-to-follow-for-usecontext)
374. [What would the context value be for no matching provider?](#374-what-would-the-context-value-be-for-no-matching-provider)

### State Management (Redux, Zustand, MobX & More)

375. [Are there any similarities between Redux and RxJS?](#375-are-there-any-similarities-between-redux-and-rxjs)
376. [Can React Hook replaces Redux?](#376-can-react-hook-replaces-redux)
377. [Can you combine **useReducer** with **useContext**?](#377-can-you-combine-usereducer-with-usecontext)
378. [Compare Redux, MobX, and Recoil for enterprise-scale state management (pros and cons).](#378-compare-redux-mobx-and-recoil-for-enterprise-scale-state-management-pros-and-cons)
379. [Context vs Redux – when to choose which?](#379-context-vs-redux-when-to-choose-which)
380. [Do I need to keep all my state into Redux? Should I ever use react internal state?](#380-do-i-need-to-keep-all-my-state-into-redux-should-i-ever-use-react-internal-state)
381. [Do you need to have a particular build tool to use Redux?](#381-do-you-need-to-have-a-particular-build-tool-to-use-redux)
382. [Explain reducers and extraReducers – when to use each?](#382-explain-reducers-and-extrareducers-when-to-use-each)
383. [Explain the flow of Redux Toolkit.](#383-explain-the-flow-of-redux-toolkit)
384. [Explain the Redux data flow (action → reducer → store → view).](#384-explain-the-redux-data-flow-action-reducer-store-view)
385. [Give an example of Reselect usage?](#385-give-an-example-of-reselect-usage)
386. [How do you make sure that user remains authenticated on page refresh while using Context API State Management?](#386-how-do-you-make-sure-that-user-remains-authenticated-on-page-refresh-while-using-context-api-state-management)
387. [How do you manage global state? Compare Context, Redux, and modern alternatives.](#387-how-do-you-manage-global-state-compare-context-redux-and-modern-alternatives)
388. [How do you pass parent data to the 5th child component?](#388-how-do-you-pass-parent-data-to-the-5th-child-component)
389. [How does `useReducer` works? Explain with an example](#389-how-does-usereducer-works-explain-with-an-example)
390. [How does Redux Toolkit work internally?](#390-how-does-redux-toolkit-work-internally)
391. [How Redux Form `initialValues` get updated from state?](#391-how-redux-form-initialvalues-get-updated-from-state)
392. [How Relay is different from Redux?](#392-how-relay-is-different-from-redux)
393. [How to access Redux store outside a component?](#393-how-to-access-redux-store-outside-a-component)
394. [How to add multiple middlewares to Redux?](#394-how-to-add-multiple-middlewares-to-redux)
395. [How to dispatch an action on load?](#395-how-to-dispatch-an-action-on-load)
396. [How to make AJAX request in Redux?](#396-how-to-make-ajax-request-in-redux)
397. [How to reset state in Redux?](#397-how-to-reset-state-in-redux)
398. [How to set initial state in Redux?](#398-how-to-set-initial-state-in-redux)
399. [How to structure Redux top level directories?](#399-how-to-structure-redux-top-level-directories)
400. [How to use `connect()` from React Redux?](#400-how-to-use-connect-from-react-redux)
401. [How would you design a state management solution for a complex analytics/dashboard app?](#401-how-would-you-design-a-state-management-solution-for-a-complex-analyticsdashboard-app)
402. [Redux vs Context API vs Zustand – how do you decide in a large-scale application?](#402-redux-vs-context-api-vs-zustand-how-do-you-decide-in-a-large-scale-application)
403. [Should I keep all component's state in Redux store?](#403-should-i-keep-all-components-state-in-redux-store)
404. [Situation: Context is causing performance issues in a large app – what do you do?](#404-situation-context-is-causing-performance-issues-in-a-large-app-what-do-you-do)
405. [What are Redux selectors and why use them?](#405-what-are-redux-selectors-and-why-use-them)
406. [What are the advantages of formik over redux form library?](#406-what-are-the-advantages-of-formik-over-redux-form-library)
407. [What are the core principles of Redux?](#407-what-are-the-core-principles-of-redux)
408. [What are the differences between `call()` and `put()` in redux-saga?](#408-what-are-the-differences-between-call-and-put-in-redux-saga)
409. [What are the differences between `redux-saga` and `redux-thunk`?](#409-what-are-the-differences-between-redux-saga-and-redux-thunk)
410. [What are the differences between Flux and Redux?](#410-what-are-the-differences-between-flux-and-redux)
411. [What are the differences between Redux and MobX?](#411-what-are-the-differences-between-redux-and-mobx)
412. [What are the different ways to write `mapDispatchToProps()`?](#412-what-are-the-different-ways-to-write-mapdispatchtoprops)
413. [What are the downsides of Redux compared to Flux?](#413-what-are-the-downsides-of-redux-compared-to-flux)
414. [What are the features of Redux DevTools?](#414-what-are-the-features-of-redux-devtools)
415. [What are the main features of Redux Form?](#415-what-are-the-main-features-of-redux-form)
416. [What are the main features of Reselect library?](#416-what-are-the-main-features-of-reselect-library)
417. [What are typical middleware choices for handling asynchronous calls in Redux?](#417-what-are-typical-middleware-choices-for-handling-asynchronous-calls-in-redux)
418. [What is `createSlice()` and what does it contain? (name, initialState, reducers)](#418-what-is-createslice-and-what-does-it-contain-name-initialstate-reducers)
419. [What is `useReducer`?](#419-what-is-usereducer)
420. [What is `useReducer`? Why do you use useReducer?](#420-what-is-usereducer-why-do-you-use-usereducer)
421. [What is an action in Redux?](#421-what-is-an-action-in-redux)
422. [What is createAsyncThunk() and why is it used?](#422-what-is-createasyncthunk-and-why-is-it-used)
423. [What is createSlice() and what does it contain?](#423-what-is-createslice-and-what-does-it-contain)
424. [What is Jotai and how does the atomic model work?](#424-what-is-jotai-and-how-does-the-atomic-model-work)
425. [What is MobX?](#425-what-is-mobx)
426. [What is prop drilling and how do you solve it?](#426-what-is-prop-drilling-and-how-do-you-solve-it)
427. [What is prop drilling? Problems and solutions.](#427-what-is-prop-drilling-problems-and-solutions)
428. [What is re-rendering and why does it happen?](#428-what-is-re-rendering-and-why-does-it-happen)
429. [What is Redux and why is it used?](#429-what-is-redux-and-why-is-it-used)
430. [What is Redux Form?](#430-what-is-redux-form)
431. [What is Redux Thunk?](#431-what-is-redux-thunk)
432. [What is Redux Toolkit and why is it recommended over plain Redux?](#432-what-is-redux-toolkit-and-why-is-it-recommended-over-plain-redux)
433. [What is redux-saga?](#433-what-is-redux-saga)
434. [What is Redux?](#434-what-is-redux)
435. [What is reselect and how it works?](#435-what-is-reselect-and-how-it-works)
436. [What is the `useSelector` / `useDispatch` pattern in Redux?](#436-what-is-the-useselector-usedispatch-pattern-in-redux)
437. [What is the difference between `mapStateToProps()` and `mapDispatchToProps()`?](#437-what-is-the-difference-between-mapstatetoprops-and-mapdispatchtoprops)
438. [What is the difference between component and container in React Redux?](#438-what-is-the-difference-between-component-and-container-in-react-redux)
439. [What is the difference between Context API and Redux Toolkit?](#439-what-is-the-difference-between-context-api-and-redux-toolkit)
440. [What is the difference between React context and React Redux?](#440-what-is-the-difference-between-react-context-and-react-redux)
441. [What is the difference between Redux, Context, and Zustand for large-scale apps?](#441-what-is-the-difference-between-redux-context-and-zustand-for-large-scale-apps)
442. [What is the flux architecture pattern?](#442-what-is-the-flux-architecture-pattern)
443. [What is the mental model of redux-saga?](#443-what-is-the-mental-model-of-redux-saga)
444. [What is the proper way to access Redux store?](#444-what-is-the-proper-way-to-access-redux-store)
445. [What is the purpose of the constants in Redux?](#445-what-is-the-purpose-of-the-constants-in-redux)
446. [What is the Redux Toolkit (RTK)?](#446-what-is-the-redux-toolkit-rtk)
447. [What is the use of the `ownProps` parameter in `mapStateToProps()` and `mapDispatchToProps()`?](#447-what-is-the-use-of-the-ownprops-parameter-in-mapstatetoprops-and-mapdispatchtoprops)
448. [What is your favorite React stack?](#448-what-is-your-favorite-react-stack)
449. [What is Zustand and how does it differ from Redux?](#449-what-is-zustand-and-how-does-it-differ-from-redux)
450. [What problems does Redux solve in large React applications?](#450-what-problems-does-redux-solve-in-large-react-applications)
451. [Whats the purpose of `at` symbol in the Redux connect decorator?](#451-whats-the-purpose-of-at-symbol-in-the-redux-connect-decorator)
452. [When should you NOT use Context for state?](#452-when-should-you-not-use-context-for-state)
453. [Where and why have you used Redux Toolkit in your projects?](#453-where-and-why-have-you-used-redux-toolkit-in-your-projects)
454. [Why are Redux state functions called reducers?](#454-why-are-redux-state-functions-called-reducers)

### React Router & Navigation

455. [How do you programmatically navigate using React Router v4?](#455-how-do-you-programmatically-navigate-using-react-router-v4)
456. [How does client-side routing work?](#456-how-does-client-side-routing-work)
457. [How to add Google Analytics for React Router?](#457-how-to-add-google-analytics-for-react-router)
458. [How to get history on React Router v4?](#458-how-to-get-history-on-react-router-v4)
459. [How to get query parameters in React Router v4?](#459-how-to-get-query-parameters-in-react-router-v4)
460. [How to implement _default_ or _NotFound_ page?](#460-how-to-implement-default-or-notfound-page)
461. [How to pass params to `history.push` method in React Router v4?](#461-how-to-pass-params-to-historypush-method-in-react-router-v4)
462. [How to perform automatic redirect after login?](#462-how-to-perform-automatic-redirect-after-login)
463. [What are nested routes in React Router v6?](#463-what-are-nested-routes-in-react-router-v6)
464. [What are render props?](#464-what-are-render-props)
465. [What are route actions in React Router?](#465-what-are-route-actions-in-react-router)
466. [What are route loaders in React Router v6.4+?](#466-what-are-route-loaders-in-react-router-v64)
467. [What are the `<Router>` components of React Router v6?](#467-what-are-the-router-components-of-react-router-v6)
468. [What are the benefits of React Router V4?](#468-what-are-the-benefits-of-react-router-v4)
469. [What are the patterns for data fetching in React?](#469-what-are-the-patterns-for-data-fetching-in-react)
470. [What is React Router and what are its main components?](#470-what-is-react-router-and-what-are-its-main-components)
471. [What is React Router?](#471-what-is-react-router)
472. [What is route based code splitting?](#472-what-is-route-based-code-splitting)
473. [What is routing in React? How does it work?](#473-what-is-routing-in-react-how-does-it-work)
474. [What is the `Outlet` component?](#474-what-is-the-outlet-component)
475. [What is the difference between `Router` and `Link` in React Router?](#475-what-is-the-difference-between-router-and-link-in-react-router)
476. [What is the difference between `useNavigate` and `<Navigate>`?](#476-what-is-the-difference-between-usenavigate-and-navigate)
477. [Why you get "Router may have only one child element" warning?](#477-why-you-get-router-may-have-only-one-child-element-warning)

### React 18/19, Concurrent Features & Suspense

478. [Are custom DOM attributes supported in React v16?](#478-are-custom-dom-attributes-supported-in-react-v16)
479. [Batching in React 18 vs React 17](#479-batching-in-react-18-vs-react-17)
480. [How does React 18's automatic batching work?](#480-how-does-react-18s-automatic-batching-work)
481. [How does React Fiber architecture change rendering?](#481-how-does-react-fiber-architecture-change-rendering)
482. [How does React Fiber works? Explain in detail.](#482-how-does-react-fiber-works-explain-in-detail)
483. [How to pretty print JSON with React?](#483-how-to-pretty-print-json-with-react)
484. [Is it possible to prevent automatic batching?](#484-is-it-possible-to-prevent-automatic-batching)
485. [Is there a functional equivalent of error boundaries?](#485-is-there-a-functional-equivalent-of-error-boundaries)
486. [React 18 automatic batching in a native event handler](#486-react-18-automatic-batching-in-a-native-event-handler)
487. [Situation: A search input lags as user types – how do you fix it?](#487-situation-a-search-input-lags-as-user-types-how-do-you-fix-it)
488. [Situation: You need to keep the UI responsive during a heavy filter operation on 10k items – how?](#488-situation-you-need-to-keep-the-ui-responsive-during-a-heavy-filter-operation-on-10k-items-how)
489. [useDeferredValue keeping input responsive during an expensive re-render](#489-usedeferredvalue-keeping-input-responsive-during-an-expensive-re-render)
490. [useTransition keeps UI responsive](#490-usetransition-keeps-ui-responsive)
491. [useTransition marking a state update as non-urgent](#491-usetransition-marking-a-state-update-as-non-urgent)
492. [What are React 19 Actions?](#492-what-are-react-19-actions)
493. [What are React Suspense and React.lazy? How do they enable code splitting?](#493-what-are-react-suspense-and-reactlazy-how-do-they-enable-code-splitting)
494. [What are the key features introduced in React 19?](#494-what-are-the-key-features-introduced-in-react-19)
495. [What is `createRoot()` and why was it introduced in React 18?](#495-what-is-createroot-and-why-was-it-introduced-in-react-18)
496. [What is `React.lazy` and how does it work?](#496-what-is-reactlazy-and-how-does-it-work)
497. [What is `startTransition`?](#497-what-is-starttransition)
498. [What is `useActionState` (React 19)?](#498-what-is-useactionstate-react-19)
499. [What is `useDeferredValue`?](#499-what-is-usedeferredvalue)
500. [What is `useOptimistic` (React 19)?](#500-what-is-useoptimistic-react-19)
501. [What is `useTransition`?](#501-what-is-usetransition)
502. [What is code splitting and how does React.lazy work internally?](#502-what-is-code-splitting-and-how-does-reactlazy-work-internally)
503. [What is code splitting at the route level?](#503-what-is-code-splitting-at-the-route-level)
504. [What is Concurrent Rendering?](#504-what-is-concurrent-rendering)
505. [What is concurrent rendering? When does it help vs hurt?](#505-what-is-concurrent-rendering-when-does-it-help-vs-hurt)
506. [What is Fiber architecture in React?](#506-what-is-fiber-architecture-in-react)
507. [What is global error monitoring in React apps?](#507-what-is-global-error-monitoring-in-react-apps)
508. [What is state batching? What changed in React 18?](#508-what-is-state-batching-what-changed-in-react-18)
509. [What is suspense component?](#509-what-is-suspense-component)
510. [What is Suspense?](#510-what-is-suspense)
511. [What is the `useTransition` hook for performance?](#511-what-is-the-usetransition-hook-for-performance)
512. [What is the behavior of uncaught errors in react 16?](#512-what-is-the-behavior-of-uncaught-errors-in-react-16)
513. [What is the difference between async mode and concurrent mode?](#513-what-is-the-difference-between-async-mode-and-concurrent-mode)
514. [What is the difference between optimistic and pessimistic updates?](#514-what-is-the-difference-between-optimistic-and-pessimistic-updates)
515. [What is the use() hook in React 19?](#515-what-is-the-use-hook-in-react-19)
516. [What is the useDeferredValue hook?](#516-what-is-the-usedeferredvalue-hook)
517. [What is the useOptimistic hook?](#517-what-is-the-useoptimistic-hook)
518. [What is the useSyncExternalStore hook?](#518-what-is-the-usesyncexternalstore-hook)
519. [What is the useTransition hook and how does it differ from useDeferredValue?](#519-what-is-the-usetransition-hook-and-how-does-it-differ-from-usedeferredvalue)
520. [Why does strict mode render twice in React?](#520-why-does-strict-mode-render-twice-in-react)

### Server-Side Rendering, Next.js & Server Components

521. [Difference between CSR, SSR, SSG, and ISR?](#521-difference-between-csr-ssr-ssg-and-isr)
522. [Explain React Server Components vs Client Components.](#522-explain-react-server-components-vs-client-components)
523. [How do you ensure a React app performs well at 100k users?](#523-how-do-you-ensure-a-react-app-performs-well-at-100k-users)
524. [How does useLayoutEffect work during server-side rendering (SSR)?](#524-how-does-uselayouteffect-work-during-server-side-rendering-ssr)
525. [How you implement Server Side Rendering or SSR?](#525-how-you-implement-server-side-rendering-or-ssr)
526. [Is it good to use `setState()` in `componentWillMount()` method?](#526-is-it-good-to-use-setstate-in-componentwillmount-method)
527. [Is it possible to use async/await in plain React?](#527-is-it-possible-to-use-asyncawait-in-plain-react)
528. [RSC vs SSR – what's the difference?](#528-rsc-vs-ssr-whats-the-difference)
529. [Situation: API data is needed in multiple components – how do you avoid duplicate fetches?](#529-situation-api-data-is-needed-in-multiple-components-how-do-you-avoid-duplicate-fetches)
530. [What are loadable components?](#530-what-are-loadable-components)
531. [What are Next.js `loading.js` and `error.js`?](#531-what-are-nextjs-loadingjs-and-errorjs)
532. [What are search params and how do you use them?](#532-what-are-search-params-and-how-do-you-use-them)
533. [What are Server Actions in React 19?](#533-what-are-server-actions-in-react-19)
534. [What are the differences between page router and app router in nextjs?](#534-what-are-the-differences-between-page-router-and-app-router-in-nextjs)
535. [What are useFormState and useFormStatus hooks?](#535-what-are-useformstate-and-useformstatus-hooks)
536. [What causes hydration mismatches and how do you fix them?](#536-what-causes-hydration-mismatches-and-how-do-you-fix-them)
537. [What is CRA and its benefits?](#537-what-is-cra-and-its-benefits)
538. [What is hydration? How do hydration mismatches occur?](#538-what-is-hydration-how-do-hydration-mismatches-occur)
539. [What is ISR (Incremental Static Regeneration)?](#539-what-is-isr-incremental-static-regeneration)
540. [What is parallel vs sequential data fetching?](#540-what-is-parallel-vs-sequential-data-fetching)
541. [What is React hydration?](#541-what-is-react-hydration)
542. [What is React?](#542-what-is-react)
543. [What is ReactDOMServer?](#543-what-is-reactdomserver)
544. [What is server-side rendering (SSR)? How does it differ from client-side rendering?](#544-what-is-server-side-rendering-ssr-how-does-it-differ-from-client-side-rendering)
545. [What is SSG (Static Site Generation)?](#545-what-is-ssg-static-site-generation)
546. [What is SSR with React?](#546-what-is-ssr-with-react)
547. [What is Streaming SSR and how does React 18+ improve it?](#547-what-is-streaming-ssr-and-how-does-react-18-improve-it)
548. [What is streaming SSR?](#548-what-is-streaming-ssr)
549. [What is the 'use client' directive?](#549-what-is-the-use-client-directive)
550. [What is the difference between React and ReactDOM?](#550-what-is-the-difference-between-react-and-reactdom)
551. [What is the Next.js App Router?](#551-what-is-the-nextjs-app-router)
552. [What is the purpose of Suspense beyond lazy loading?](#552-what-is-the-purpose-of-suspense-beyond-lazy-loading)
553. [What is the use of `react-dom` package?](#553-what-is-the-use-of-react-dom-package)
554. [When to use client and server components?](#554-when-to-use-client-and-server-components)

### Error Handling & Error Boundaries

555. [Can you describe about componentDidCatch lifecycle method signature?](#555-can-you-describe-about-componentdidcatch-lifecycle-method-signature)
556. [Design a real-time chat UI in React.](#556-design-a-real-time-chat-ui-in-react)
557. [Do Hooks cover all the functionalities provided by the classes?](#557-do-hooks-cover-all-the-functionalities-provided-by-the-classes)
558. [Error boundary catches what?](#558-error-boundary-catches-what)
559. [How are error boundaries handled in React v15?](#559-how-are-error-boundaries-handled-in-react-v15)
560. [How do you create an error boundary?](#560-how-do-you-create-an-error-boundary)
561. [In which scenarios error boundaries do not catch errors?](#561-in-which-scenarios-error-boundaries-do-not-catch-errors)
562. [Is Hooks cover all use cases for classes?](#562-is-hooks-cover-all-use-cases-for-classes)
563. [Situation: A critical bug is in production – what's your process?](#563-situation-a-critical-bug-is-in-production-whats-your-process)
564. [Situation: A third-party component throws – how do you handle it?](#564-situation-a-third-party-component-throws-how-do-you-handle-it)
565. [What are error boundaries?](#565-what-are-error-boundaries)
566. [What are the methods invoked during error handling?](#566-what-are-the-methods-invoked-during-error-handling)
567. [What is the benefit of component stack trace from error boundary?](#567-what-is-the-benefit-of-component-stack-trace-from-error-boundary)
568. [What is the proper placement for error boundaries?](#568-what-is-the-proper-placement-for-error-boundaries)
569. [What is the purpose of getDerivedStateFromError?](#569-what-is-the-purpose-of-getderivedstatefromerror)

### Component Design Patterns (HOC, Render Props, Compound Components)

570. [Custom hooks vs HOCs vs render props – when to use each?](#570-custom-hooks-vs-hocs-vs-render-props-when-to-use-each)
571. [Do Hooks replace render props and higher order components?](#571-do-hooks-replace-render-props-and-higher-order-components)
572. [Higher-Order Component (HOC) that logs props on every render](#572-higher-order-component-hoc-that-logs-props-on-every-render)
573. [How do you create HOC using render props?](#573-how-do-you-create-hoc-using-render-props)
574. [How do you prevent prop explosion in complex components?](#574-how-do-you-prevent-prop-explosion-in-complex-components)
575. [How does the performance of using Hooks will differ in comparison with the classes?](#575-how-does-the-performance-of-using-hooks-will-differ-in-comparison-with-the-classes)
576. [How to create props proxy for HOC component?](#576-how-to-create-props-proxy-for-hoc-component)
577. [How to format date using React Intl?](#577-how-to-format-date-using-react-intl)
578. [How to use `<FormattedMessage>` as placeholder using React Intl?](#578-how-to-use-formattedmessage-as-placeholder-using-react-intl)
579. [Must prop be named as render for render props?](#579-must-prop-be-named-as-render-for-render-props)
580. [Render props pattern — headless component sharing fetch logic](#580-render-props-pattern-headless-component-sharing-fetch-logic)
581. [What are compound components?](#581-what-are-compound-components)
582. [What are Custom Hooks?](#582-what-are-custom-hooks)
583. [What are Higher Order Components?](#583-what-are-higher-order-components)
584. [What are HOC factory implementations?](#584-what-are-hoc-factory-implementations)
585. [What are the limitations with HOCs?](#585-what-are-the-limitations-with-hocs)
586. [What are the problems of using render props with pure components?](#586-what-are-the-problems-of-using-render-props-with-pure-components)
587. [What are the sources used for introducing hooks?](#587-what-are-the-sources-used-for-introducing-hooks)
588. [What is a hook? Why were hooks introduced?](#588-what-is-a-hook-why-were-hooks-introduced)
589. [What is render hijacking in react?](#589-what-is-render-hijacking-in-react)
590. [What is the difference between useMemo and React.memo?](#590-what-is-the-difference-between-usememo-and-reactmemo)
591. [What is the provider pattern?](#591-what-is-the-provider-pattern)
592. [What is the purpose of displayName class property?](#592-what-is-the-purpose-of-displayname-class-property)
593. [What is the purpose of forward ref in HOCs?](#593-what-is-the-purpose-of-forward-ref-in-hocs)
594. [What is the state reducer pattern?](#594-what-is-the-state-reducer-pattern)

### Testing React Applications

595. [Give a simple example of Jest test case](#595-give-a-simple-example-of-jest-test-case)
596. [How do you test user interactions?](#596-how-do-you-test-user-interactions)
597. [How would you implement internationalization (i18n) in React?](#597-how-would-you-implement-internationalization-i18n-in-react)
598. [What are the advantages of Jest over Jasmine?](#598-what-are-the-advantages-of-jest-over-jasmine)
599. [What is Jest?](#599-what-is-jest)
600. [What is React Testing Library?](#600-what-is-react-testing-library)
601. [What is Shallow Renderer in React testing?](#601-what-is-shallow-renderer-in-react-testing)
602. [What is the difference between shallow and deep rendering?](#602-what-is-the-difference-between-shallow-and-deep-rendering)
603. [What is the purpose of ReactTestUtils package?](#603-what-is-the-purpose-of-reacttestutils-package)
604. [What is the stable release for hooks support?](#604-what-is-the-stable-release-for-hooks-support)
605. [What is the testing pyramid for React?](#605-what-is-the-testing-pyramid-for-react)

### TypeScript with React

606. [`React.FC` vs explicit return type – which is better?](#606-reactfc-vs-explicit-return-type-which-is-better)
607. [How do you design a reusable button component?](#607-how-do-you-design-a-reusable-button-component)
608. [How do you get redux scaffolding using create-react-app?](#608-how-do-you-get-redux-scaffolding-using-create-react-app)
609. [How do you type `useReducer`?](#609-how-do-you-type-usereducer)
610. [How do you type `useState` with TypeScript?](#610-how-do-you-type-usestate-with-typescript)
611. [How do you type children in React with TypeScript?](#611-how-do-you-type-children-in-react-with-typescript)
612. [How do you type component props with TypeScript?](#612-how-do-you-type-component-props-with-typescript)
613. [How is React different from Angular or Vue?](#613-how-is-react-different-from-angular-or-vue)
614. [How should you structure a large React application?](#614-how-should-you-structure-a-large-react-application)
615. [How to use TypeScript in `create-react-app` application?](#615-how-to-use-typescript-in-create-react-app-application)
616. [How would you architect a React app for a team of 20 developers?](#616-how-would-you-architect-a-react-app-for-a-team-of-20-developers)
617. [How would you build a custom hook library?](#617-how-would-you-build-a-custom-hook-library)
618. [How would you design a design system in React?](#618-how-would-you-design-a-design-system-in-react)
619. [Situation: A dropdown closes when you click inside it – what's likely wrong?](#619-situation-a-dropdown-closes-when-you-click-inside-it-whats-likely-wrong)
620. [What are the benefits of using TypeScript with ReactJS?](#620-what-are-the-benefits-of-using-typescript-with-reactjs)
621. [What are the features of create react app?](#621-what-are-the-features-of-create-react-app)
622. [What are the recommended ways for static type checking?](#622-what-are-the-recommended-ways-for-static-type-checking)
623. [What is a discriminated union and when is it useful in React?](#623-what-is-a-discriminated-union-and-when-is-it-useful-in-react)
624. [Why use TypeScript with React?](#624-why-use-typescript-with-react)

### Accessibility (a11y) in React

625. [How do you build a reusable modal?](#625-how-do-you-build-a-reusable-modal)
626. [How do you handle keyboard navigation in custom components?](#626-how-do-you-handle-keyboard-navigation-in-custom-components)
627. [How would you build a drag-and-drop kanban board?](#627-how-would-you-build-a-drag-and-drop-kanban-board)
628. [What are ARIA roles and attributes?](#628-what-are-aria-roles-and-attributes)
629. [What are headless components?](#629-what-are-headless-components)
630. [What are the popular React-specific linters?](#630-what-are-the-popular-react-specific-linters)
631. [What are the RTL query priorities?](#631-what-are-the-rtl-query-priorities)
632. [What is `useId`?](#632-what-is-useid)
633. [What is a focus trap?](#633-what-is-a-focus-trap)
634. [What is a skip link?](#634-what-is-a-skip-link)
635. [What is focus management and why does it matter?](#635-what-is-focus-management-and-why-does-it-matter)
636. [What is the purpose of ESLint and Prettier in a React project?](#636-what-is-the-purpose-of-eslint-and-prettier-in-a-react-project)
637. [What is the useId hook and when should you use it?](#637-what-is-the-useid-hook-and-when-should-you-use-it)
638. [What is Vitest and how does it differ from Jest?](#638-what-is-vitest-and-how-does-it-differ-from-jest)
639. [What tools help check React app accessibility?](#639-what-tools-help-check-react-app-accessibility)
640. [Why do React Hooks make use of refs?](#640-why-do-react-hooks-make-use-of-refs)
641. [Why does accessibility matter in React apps?](#641-why-does-accessibility-matter-in-react-apps)

### Security in React

642. [Can I use javascript urls in react16.9?](#642-can-i-use-javascript-urls-in-react169)
643. [How do you securely store auth tokens in a React app?](#643-how-do-you-securely-store-auth-tokens-in-a-react-app)
644. [How does React prevent XSS by default?](#644-how-does-react-prevent-xss-by-default)
645. [How to use innerHTML in React?](#645-how-to-use-innerhtml-in-react)
646. [How to use styles in React?](#646-how-to-use-styles-in-react)
647. [What is `dangerouslySetInnerHTML` and why is it dangerous?](#647-what-is-dangerouslysetinnerhtml-and-why-is-it-dangerous)
648. [What is a CSRF attack and how do you prevent it in React apps?](#648-what-is-a-csrf-attack-and-how-do-you-prevent-it-in-react-apps)

### React Native

649. [Can Redux only be used with React?](#649-can-redux-only-be-used-with-react)
650. [How React Router is different from history library?](#650-how-react-router-is-different-from-history-library)
651. [How to combine multiple inline style objects?](#651-how-to-combine-multiple-inline-style-objects)
652. [How to debug your React Native?](#652-how-to-debug-your-react-native)
653. [How to do logging in React Native?](#653-how-to-do-logging-in-react-native)
654. [How to test React Native apps?](#654-how-to-test-react-native-apps)
655. [What is `TestRenderer` package in React?](#655-what-is-testrenderer-package-in-react)
656. [What is React Dev Tools?](#656-what-is-react-dev-tools)
657. [What is the difference between React Native and React?](#657-what-is-the-difference-between-react-native-and-react)

### React Ecosystem, Libraries & Internationalization

658. [Give an example of Styled Components?](#658-give-an-example-of-styled-components)
659. [How do you do form validation in React without a library?](#659-how-do-you-do-form-validation-in-react-without-a-library)
660. [How do you integrate a non-React library (e.g., D3, Leaflet)?](#660-how-do-you-integrate-a-non-react-library-eg-d3-leaflet)
661. [How do you memoize a component?](#661-how-do-you-memoize-a-component)
662. [How do you use immer library for state updates?](#662-how-do-you-use-immer-library-for-state-updates)
663. [How does ReactJS work behind the scenes?](#663-how-does-reactjs-work-behind-the-scenes)
664. [How to make AJAX call and in which component lifecycle methods should I make an AJAX call?](#664-how-to-make-ajax-call-and-in-which-component-lifecycle-methods-should-i-make-an-ajax-call)
665. [Is it recommended to use CSS In JS technique in React?](#665-is-it-recommended-to-use-css-in-js-technique-in-react)
666. [Should I learn ES6 before learning ReactJS?](#666-should-i-learn-es6-before-learning-reactjs)
667. [What are common React performance pitfalls?](#667-what-are-common-react-performance-pitfalls)
668. [What are Styled Components?](#668-what-are-styled-components)
669. [What are the common usecases of useRef hook?](#669-what-are-the-common-usecases-of-useref-hook)
670. [What are the differences between useEffect and useLayoutEffect hooks?](#670-what-are-the-differences-between-useeffect-and-uselayouteffect-hooks)
671. [What are the limitations of React?](#671-what-are-the-limitations-of-react)
672. [What are the major features of React?](#672-what-are-the-major-features-of-react)
673. [What are the popular packages for animation?](#673-what-are-the-popular-packages-for-animation)
674. [What are the two ways of formatting in React Intl?](#674-what-are-the-two-ways-of-formatting-in-react-intl)
675. [What are the use cases of useContext hook?](#675-what-are-the-use-cases-of-usecontext-hook)
676. [What are the usecases of useLayoutEffect?](#676-what-are-the-usecases-of-uselayouteffect)
677. [What environment variables are safe to expose in a React app?](#677-what-environment-variables-are-safe-to-expose-in-a-react-app)
678. [What is a monorepo and how does it relate to React projects?](#678-what-is-a-monorepo-and-how-does-it-relate-to-react-projects)
679. [What is bundle analysis and how do you do it?](#679-what-is-bundle-analysis-and-how-do-you-do-it)
680. [What is flux?](#680-what-is-flux)
681. [What is Formik?](#681-what-is-formik)
682. [What is React and what problem does it solve?](#682-what-is-react-and-what-problem-does-it-solve)
683. [What is React Intl?](#683-what-is-react-intl)
684. [What is React JS?](#684-what-is-react-js)
685. [What is React Query (TanStack Query)?](#685-what-is-react-query-tanstack-query)
686. [What is React?](#686-what-is-react)
687. [What is Storybook?](#687-what-is-storybook)
688. [What is the 'why did you render' library?](#688-what-is-the-why-did-you-render-library)
689. [What is the difference between Shadow DOM and Virtual DOM?](#689-what-is-the-difference-between-shadow-dom-and-virtual-dom)
690. [What is the popular choice for form handling?](#690-what-is-the-popular-choice-for-form-handling)
691. [What is the useInsertionEffect hook?](#691-what-is-the-useinsertioneffect-hook)
692. [What is the virtual DOM? How does react use the virtual DOM to render the UI?](#692-what-is-the-virtual-dom-how-does-react-use-the-virtual-dom-to-render-the-ui)
693. [What is windowing technique?](#693-what-is-windowing-technique)
694. [What is windowing/virtualization and when do you need it?](#694-what-is-windowingvirtualization-and-when-do-you-need-it)
695. [When do you need to use refs?](#695-when-do-you-need-to-use-refs)
696. [Why do you need additional care for component libraries while using forward refs?](#696-why-do-you-need-additional-care-for-component-libraries-while-using-forward-refs)
697. [Why ReactDOM is separated from React?](#697-why-reactdom-is-separated-from-react)

### Build Tools & Developer Experience

698. [Do browsers understand JSX code?](#698-do-browsers-understand-jsx-code)
699. [How do you measure and fix excessive re-renders?](#699-how-do-you-measure-and-fix-excessive-re-renders)
700. [How does tree shaking work in modern bundlers?](#700-how-does-tree-shaking-work-in-modern-bundlers)
701. [How to add Bootstrap to a react application?](#701-how-to-add-bootstrap-to-a-react-application)
702. [How to avoid using relative path imports in create-react-app?](#702-how-to-avoid-using-relative-path-imports-in-create-react-app)
703. [How to debug forwardRefs in DevTools?](#703-how-to-debug-forwardrefs-in-devtools)
704. [How to enable production mode in React?](#704-how-to-enable-production-mode-in-react)
705. [How to ensure hooks followed the rules in your project?](#705-how-to-ensure-hooks-followed-the-rules-in-your-project)
706. [How to set state with a dynamic key name?](#706-how-to-set-state-with-a-dynamic-key-name)
707. [How to use https instead of http in create-react-app?](#707-how-to-use-https-instead-of-http-in-create-react-app)
708. [Situation: The app is slow on mobile – how do you diagnose and fix it?](#708-situation-the-app-is-slow-on-mobile-how-do-you-diagnose-and-fix-it)
709. [What are the approaches to include polyfills in your `create-react-app`?](#709-what-are-the-approaches-to-include-polyfills-in-your-create-react-app)
710. [What are the best practices for using React Hooks?](#710-what-are-the-best-practices-for-using-react-hooks)
711. [What is `useDebugValue`?](#711-what-is-usedebugvalue)
712. [What is a CORS issue and how do you handle it?](#712-what-is-a-cors-issue-and-how-do-you-handle-it)
713. [What is code-splitting?](#713-what-is-code-splitting)
714. [What is JSX and how is it rendered in the browser?](#714-what-is-jsx-and-how-is-it-rendered-in-the-browser)
715. [What is react scripts?](#715-what-is-react-scripts)
716. [What is the Profiler API?](#716-what-is-the-profiler-api)
717. [What is the purpose of eslint plugin for hooks?](#717-what-is-the-purpose-of-eslint-plugin-for-hooks)
718. [What is the React DevTools and what can you do with it?](#718-what-is-the-react-devtools-and-what-can-you-do-with-it)
719. [What is the role of Babel in a React project?](#719-what-is-the-role-of-babel-in-a-react-project)
720. [What is the useDebugValue hook?](#720-what-is-the-usedebugvalue-hook)
721. [What is tree shaking?](#721-what-is-tree-shaking)
722. [What is Vite and why is it preferred over CRA?](#722-what-is-vite-and-why-is-it-preferred-over-cra)
723. [Why is DevTools not loading in Chrome for local files?](#723-why-is-devtools-not-loading-in-chrome-for-local-files)
724. [Why React tab is not showing up in DevTools?](#724-why-react-tab-is-not-showing-up-in-devtools)

### Debugging & Fix-It

725. [Fix a `useEffect` that has missing dependencies (the ESLint exhaustive-deps warning)](#725-fix-a-useeffect-that-has-missing-dependencies-the-eslint-exhaustive-deps-warning)
726. [Given a slow React tree, how do you identify and fix the performance bottleneck?](#726-given-a-slow-react-tree-how-do-you-identify-and-fix-the-performance-bottleneck)

### Architecture, System Design & Senior-Level Scenarios

727. [Why React.js? What problems does it solve?](#727-why-reactjs-what-problems-does-it-solve)

### Miscellaneous & General

728. [`getBy` vs `queryBy` vs `findBy` – when do you use each?](#728-getby-vs-queryby-vs-findby-when-do-you-use-each)
729. [Can you list down top websites or applications using react as front end framework?](#729-can-you-list-down-top-websites-or-applications-using-react-as-front-end-framework)
730. [Explain Strict Mode in React.](#730-explain-strict-mode-in-react)
731. [How do you pass arguments to an event handler?](#731-how-do-you-pass-arguments-to-an-event-handler)
732. [How do you test async behavior (e.g., API calls)?](#732-how-do-you-test-async-behavior-eg-api-calls)
733. [How do you type event handlers?](#733-how-do-you-type-event-handlers)
734. [How do you update rendered elements?](#734-how-do-you-update-rendered-elements)
735. [How to prevent a function from being called multiple times?](#735-how-to-prevent-a-function-from-being-called-multiple-times)
736. [What are capture phase events?](#736-what-are-capture-phase-events)
737. [What are the advantages of React over Vue.js?](#737-what-are-the-advantages-of-react-over-vuejs)
738. [What are the common folder structures for React?](#738-what-are-the-common-folder-structures-for-react)
739. [What are the conditions to safely use the index as a key?](#739-what-are-the-conditions-to-safely-use-the-index-as-a-key)
740. [What are the drawbacks of MVW pattern?](#740-what-are-the-drawbacks-of-mvw-pattern)
741. [What are the main features of React Intl?](#741-what-are-the-main-features-of-react-intl)
742. [What are the Pointer Events supported in React?](#742-what-are-the-pointer-events-supported-in-react)
743. [What happened to event pooling?](#743-what-happened-to-event-pooling)
744. [What happens if you use useLayoutEffect for non-layout logic?](#744-what-happens-if-you-use-uselayouteffect-for-non-layout-logic)
745. [What is a React SPA and what are its trade-offs?](#745-what-is-a-react-spa-and-what-are-its-trade-offs)
746. [What is dynamic import?](#746-what-is-dynamic-import)
747. [What is Flow?](#747-what-is-flow)
748. [What is Mock Service Worker (MSW)?](#748-what-is-mock-service-worker-msw)
749. [What is optimistic mutation in React Query?](#749-what-is-optimistic-mutation-in-react-query)
750. [What is Relay?](#750-what-is-relay)
751. [What is the browser support for react applications?](#751-what-is-the-browser-support-for-react-applications)
752. [What is the difference between React and Angular?](#752-what-is-the-difference-between-react-and-angular)
753. [What is the history behind React evolution?](#753-what-is-the-history-behind-react-evolution)
754. [What is the purpose of `push()` and `replace()` methods of `history`?](#754-what-is-the-purpose-of-push-and-replace-methods-of-history)
755. [What is the purpose of registerServiceWorker in React?](#755-what-is-the-purpose-of-registerserviceworker-in-react)
756. [What is the purpose of renderToNodeStream method?](#756-what-is-the-purpose-of-rendertonodestream-method)
757. [Why avoid array index as key?](#757-why-avoid-array-index-as-key)
758. [Why fragments are better than container divs?](#758-why-fragments-are-better-than-container-divs)
...
### 2. How can we find the version of React at runtime in the browser?
...
### 3. How do you apply vendor prefixes to inline styles in React?
...
### 4. How do you print falsy values in JSX?
...
### 5. How events are different in React?
...
### 6. How is the new JSX transform different from old transform??
...
### 8. How to pass a parameter to an event handler or callback?
...
### 10. How to use React label element?
...
### 11. How to write comments in React?
...
### 12. Is it possible to use React without rendering HTML?
...
### 13. What are the possible return types of render method?
...
### 14. What is React Query's caching model?
...
### 17. What is the reason behind multiple JSX tags to be wrapped?
...
### 19. Can I dispatch an action in reducer?
...
### 20. Can I import an SVG file as react component?
...
### 21. Can I use keys for non-list items?
...
### 22. Can I use web components in react application?
...
### 23. Describe about data flow in react?
...
### 24. Does React support all HTML attributes?
...
### 25. Does the statics object work with ES6 classes in React?
...
### 27. How do you access imperative API of web components?
...
### 28. How do you access props in attribute quotes?
...
### 29. How do you conditionally render components?
...
### 30. How do you prevent mutating array variables?
...
### 31. How do you protect routes (auth guards)?
...
### 32. How do you say that props are read only?
...
### 33. How do you say that props are readonly?
...
### 34. How do you say that state updates are merged?
...
### 35. How do you test components with context?
...
### 36. How do you update objects inside state?
...
### 37. How does React updates screen in an application?
...
### 38. How does useLayoutEffect cause layout thrashing?
...
### 39. How React PropTypes allow different types for one prop?
...
### 40. How to access current locale with React Intl?
...
### 42. How to bind methods or event handlers in JSX callbacks?
...
### 43. How to conditionally apply class attributes?
...
### 44. How to create a switching component for displaying different pages?
...
### 45. How to create components in React?
...
### 46. How to create react class components without ES6?
...
### 48. How to define constants in React?
...
### 49. How to import and export components using React and ES6?
...
### 50. How to pass numbers to React component?
...
### 51. How to prevent component from rendering?
...
### 52. How to use class field declarations syntax in React classes?
...
### 53. How to use Font Awesome icons in React?
...
### 54. How to use Polymer in React?
...
### 56. Is it good to use arrow functions in render methods?
...
### 57. Is it mandatory to define constructor for React component?
...
### 58. Is it possible to use react without JSX?
...
### 59. Is ref argument available for all functions or class components?
...
### 60. Is that possible to use useImperativeHandle without forwardRef?
...
### 61. Render order of nested Parent → Child → GrandChild components
...
### 62. Situation: Two components on different branches need the same data – what do you do?
...
### 66. What are inline conditional expressions?
...
### 69. What are React elements vs React components?
...
### 70. What are React Portals, and when would you use them?
...
### 71. What are synthetic events in React?
...
### 72. What are the benefits of preventing the direct state mutations?
...
### 73. What are the different ways to style a React component?
...
### 74. What are the exceptions on React component naming?
...
### 75. What are the guidelines to be followed for writing reducers?
...
### 76. What are the possible ways of updating objects in state?
...
### 77. What are the preferred and non-preferred array operations for updating the state?
...
### 84. What is a wrapper component?
...
### 85. What is an updater function? Should an updater function be used in all cases?
...
### 87. What is colocation in React?
...
### 88. What is forwardRef, and when do you need it?
...
### 89. What is HMR (Hot Module Replacement)?
...
### 90. What is JSX and why does React use it?
...
### 92. What is Lifting State Up in React?
...
### 93. What is prop inversion of control?
...
### 95. What is React.Fragment and why is it useful?
...
### 96. What is server state vs client state?
...
### 97. What is state mutation and how to prevent it?
...
### 98. What is the benefit of styles modules?
...
### 99. What is the difference between `setState()` and `replaceState()` methods?
...
### 100. What is the difference between `super()` and `super(props)` in React using ES6 classes?
...
### 101. What is the difference between an Element and a Component?
...
### 102. What is the difference between constructor and getInitialState?
...
### 103. What is the difference between Flow and PropTypes?
...
### 104. What is the difference between Imperative and Declarative in React?
...
### 105. What is the difference between try catch block and error boundaries?
...
### 106. What is the main purpose of constructor?
...
### 107. What is the purpose of render method of `react-dom`?
...
### 108. What is the purpose of unmountComponentAtNode method?
...
### 109. What is the purpose of using super constructor with props argument?
...
### 110. What is the recommended approach of removing an array element in React state?
...
### 111. What is the recommended way for naming components?
...
### 112. What is the required method to be defined for a class component?
...
### 113. What is the typical use case of portals?
...
### 115. What will happen by defining nested function components?
...
### 116. What will happen if you use props in initial state?
...
### 117. What would be the common mistake of function being called every time the component renders?
...
### 118. When component props defaults to true?
...
### 119. When should a component be split into smaller components?
...
### 120. Why are inline ref callbacks or functions not recommended?
...
### 121. Why are keys important in lists? What happens if keys are unstable?
...
### 122. Why are String Refs legacy?
...
### 123. Why can't you update props in React?
...
### 124. Why do you not required to use inheritance?
...
### 125. Why is `isMounted()` an anti-pattern and what is the proper solution?
...
### 126. Why should component names start with capital letter?
...
### 127. Why we need to be careful when spreading props on DOM elements?
...
### 128. Why we need to pass a function to setState()?
...
### 129. Build a custom hook like `useDebounce` or `useFetch`.
...
### 130. Calling a hook conditionally inside an if block
...
### 131. Can Hooks be used in class components?
...
### 132. Can useState take a function as an initial value?
...
### 133. Can you dispatch multiple actions in a row with useReducer?
...
### 134. Can you explain how useState works internally?
...
### 135. Can you have multiple useEffect hooks in a single component?
...
### 136. Design a form wizard with multiple steps in React.
...
### 137. Differentiate React Hooks vs Classes.
...
### 138. Do I need to rewrite all my class components with hooks?
...
### 139. Does React Hook work with static typing?
...
### 140. Event bubbling through a React portal rendered outside the DOM parent
...
### 141. Explain about types of side effects in React component.
...
### 142. Explain how to create a simple React Hooks example program.
...
### 144. Explain useEffect deeply — cleanup, dependency array pitfalls.
...
### 145. Functional update vs direct update
...
### 146. How do reactive dependencies in the useEffect dependency array affect its execution behavior?
...
### 147. How do you create a custom hook?
...
### 148. How do you handle cleanup in useEffect?
...
### 149. How do you handle errors in `useEffect`?
...
### 150. How do you manage focus after navigation in a SPA?
...
### 151. How do you share state logic between components using custom hooks?
...
### 153. How Do You Use useRef to Access a DOM Element in React? Give an example.
...
### 154. How is `useReducer` Different from `useState`?
...
### 155. How to listen to state changes?
...
### 156. How to pass data between react components?
...
### 157. How to prevent infinite loops with useEffect?
...
### 158. How to update a component every second?
...
### 159. How would you handle real-time data updates (live prices, scores)?
...
### 160. How would you migrate a large class-based codebase to hooks?
...
### 161. Is it possible to access a ref in the render method?
...
### 162. Is useState Synchronous or Asynchronous?
...
### 163. Multiple setState calls in one handler
...
### 165. Order of setState calls, componentDidMount and componentDidUpdate in a class component
...
### 166. Stale closure in useEffect
...
### 167. State update is asynchronous
...
### 168. Two components using the same custom hook — do they share state?
...
### 170. useEffect mount/unmount order when toggling between two sibling components
...
### 171. useEffect vs useLayoutEffect timing
...
### 172. useEffect with async function
...
### 173. useEffect with empty dependency array
...
### 174. useReducer vs useState for complex state
...
### 175. useRef to track previous value
...
### 176. What are Custom React Hooks, and How Can You Develop One?
...
### 177. What are presentational vs container components?
...
### 178. What are stale closures in `useEffect`?
...
### 179. What are stateful components?
...
### 180. What are stateless components?
...
### 181. What are the differences between functional and class components?
...
### 182. What are the different phases of component lifecycle?
...
### 183. What are the lifecycle methods going to be deprecated in React v16?
...
### 184. What are the lifecycle methods of React?
...
### 185. What are the rules needs to follow for hooks?
...
### 186. What are the Rules of Hooks?
...
### 187. What happens if you call `useState` conditionally?
...
### 188. What happens if you return a Promise from useEffect??
...
### 189. What is `getSnapshotBeforeUpdate`?
...
### 192. What is lazy initialization in `useState`?
...
### 194. What is the `useEffect` cleanup function?
...
### 195. What is the container/presenter pattern and is it still relevant?
...
### 196. What is the difference between useEffect and useLayoutEffect?
...
### 197. What is the lifecycle methods order in mounting?
...
### 198. What is the order of hook execution in a component?
...
### 199. What is the recommended ordering of methods in component class?
...
### 200. What is the use of useEffect React Hooks?
...
### 202. What is useImperativeHandle Hook? Give an example.
...
### 203. What is useReducer, and when would you use it over useState?
...
### 205. What rules need to be followed for hooks?
...
### 206. When and how often does React invoke the setup and cleanup functions inside a useEffect hook?
...
### 207. When does a child's useEffect cleanup run vs the parent's cleanup?
...
### 208. When should you use useImperativeHandle?
...
### 209. When to use a Class Component over a Function Component?
...
### 210. Which is preferred option with in callback refs and findDOMNode()?
...
### 211. Why do we use array destructuring (square brackets notation) in `useState`?
...
### 212. Why do you not need error boundaries for event handlers?
...
### 213. Why should not call setState in componentWillUnmount?
...
### 214. Why use functional updates with `useState`?
...
### 215. `useMemo` vs `useCallback` – what's the difference?
...
### 216. A React component re-renders again and again but you never called setState. Why?
...
### 217. Can useRef be used to store previous values?
...
### 218. Can you describe the useMemo() Hook?
...
### 219. Can you force a component to re-render without calling setState?
...
### 220. Can you use useRef to persist values across renders??
...
### 221. Child re-render when parent re-renders
...
### 222. Context re-render behavior – what should you know?
...
### 223. Context value change causing child re-render (and same-value updates)
...
### 224. Context value change re-renders all consumers
...
### 225. Controlled vs uncontrolled forms – trade-offs in practice?
...
### 226. Defining a child component inside a parent's render function
...
### 227. Does the lazy function support named exports?
...
### 228. Does useMemo prevent re-rendering of child components?
...
### 229. Explain the concept of "controlled re‑render boundaries".
...
### 230. Force-updating a component after mutating a ref directly
...
### 231. How do you avoid unnecessary object/function recreation?
...
### 232. How do you handle real-time updates efficiently in React?
...
### 233. How do you solve performance corner cases while using context?
...
### 234. How does `useRef` differ from a regular variable?
...
### 235. How does React batch multiple state updates?
...
### 236. How to prevent re-renders in React?
...
### 237. How to prevent unnecessary updates using setState?
...
### 238. How to re-render the view when the browser is resized?
...
### 239. How would you implement infinite scroll?
...
### 240. How would you optimize a React application rendering 100,000+ items in a list?
...
### 242. Is dispatch from useReducer asynchronous and does it update state immediately?
...
### 243. Map class lifecycle methods to hooks.
...
### 244. Name a few techniques to optimize React app performance.
...
### 245. Object state partial update
...
### 246. Re-render on same state value
...
### 247. React.memo with object prop
...
### 248. React.useMemo() memoizing a JSX element to skip a child's re-render
...
### 249. Scenario: Context API causes frequent re‑renders – why and how to fix?
...
### 250. Situation: `useEffect` runs infinitely – what's wrong?
...
### 252. useCallback returning a stable function reference across re-renders
...
### 253. useCallback without dependency change
...
### 256. useMemo recomputing when a dependency array value is a new array reference each render
...
### 257. useRef does not cause re-render
...
### 258. What are common React performance optimization techniques? (practical guide)
...
### 261. What are the benefits of new JSX transform?
...
### 262. What are the differences between useEffect and useEvent (experimental)?
...
### 263. What are the hidden reasons a component re‑renders even when props don't change?
...
### 264. What are the three main lifecycle phases?
...
### 265. What causes unnecessary re-renders in React?
...
### 266. What does 'declarative' mean in React?
...
### 267. What happens if a child uses React.memo() and parent props don't change?
...
### 268. What happens if a component wrapped in `memo()` has its own state changes?
...
### 269. What happens if you mutate state directly?
...
### 270. What happens when a parent re-renders?
...
### 271. What is `getDerivedStateFromProps` and when would you use it?
...
### 272. What is `shouldComponentUpdate` and its functional equivalent?
...
### 273. What is `useCallback` and why is it used?
...
### 278. What is React Hook Form and why is it popular?
...
### 279. What is React lazy function?
...
### 280. What is React memo function?
...
### 281. What is React.memo? How is it different from useMemo and useCallback?
...
### 283. What is the difference between element and component re-render?
...
### 284. What is the difference between useMemo and useCallback?


useMemo memoizes the RESULT of a computation — returns cached value until deps change. Use for expensive calculations. useCallback memoizes a FUNCTION DEFINITION — returns same function reference until deps change. Use when passing callbacks to memoized child components. Key distinction: useMemo = memo(fn()), useCallback = memo(fn). When NOT to use useMemo: (1) simple calculations where memoization overhead exceeds savings. (2) Values that change on every render anyway. Overusing them adds memory and comparison overhead.
...
### 285. What is the difference between useState and useRef hook?
...
### 286. What is the methods order when component re-rendered?
...
### 287. What is the purpose of `getDerivedStateFromProps()` lifecycle method?
...
### 288. What is the purpose of callback function as an argument of `setState()`?
...
### 289. What is the React Compiler (React Forget)?
...
### 290. What problems does `useMemo` actually solve? When should you NOT use it?
...
### 291. What types of values can `useState` hold?
...
### 292. What will happen if you use `setState()` in constructor?
...
### 293. What's a common pitfall when using useContext with objects?
...
### 294. When does `React.memo` NOT help?
...
### 295. When would you use `React.memo`?
...
### 296. Why should we not update the state directly?
...
### 297. Build a controlled form with validation (email, password strength)
...
### 298. Build a counter that increments and decrements
...
### 299. Build a data grid/table with sort, filter, and pagination
...
### 300. Build a drag-and-drop list (without libraries)
...
### 301. Build a file upload component with drag-and-drop, progress, and preview
...
### 302. Build a Kanban board with columns and drag-and-drop cards
...
### 303. Build a Modal with focus trap and Escape key to close
...
### 304. Build a multi-step form wizard with Next/Back navigation and validation
...
### 305. Build a search input with debouncing that fetches from an API
...
### 306. Build a Star Rating component
...
### 307. Build a Todo App (CRUD + filter + localStorage persistence)
...
### 308. Build a tree view (expandable/collapsible nodes)
...
### 309. Build a typeahead / autocomplete component with keyboard navigation
...
### 310. Build an Accordion (single/multi open behavior)
...
### 311. Build tabs with lazy-loaded content
...
### 312. Implement a carousel/image slider
...
### 313. Implement a custom `useAsync` hook (manage async function states)
...
### 314. Implement a custom `useClickOutside` hook
...
### 315. Implement a custom `useDebounce` hook
...
### 316. Implement a custom `useEventListener` hook
...
### 317. Implement a custom `useFetch` hook (loading/error/data states)
...
### 318. Implement a custom `useIntersectionObserver` hook
...
### 319. Implement a custom `useLocalStorage` hook
...
### 320. Implement a custom `useMediaQuery` hook
...
### 321. Implement a custom `usePrevious` hook (returns previous state value)
...
### 322. Implement a custom `useThrottle` hook
...
### 323. Implement a custom `useWindowSize` hook
...
### 324. Implement a recursive comment thread (nested comments with reply)
...
### 325. Implement a virtualized list (render only visible rows)
...
### 326. Implement pagination (client-side and server-side)
...
### 327. What is `flushSync`? When would you use it?
...
### 328. What is the `use server` directive (Next.js Server Actions)?
...
### 330. What are the advantages of using React?
...
### 331. What is event delegation in React?
...
### 333. What is the difference between Real DOM and Virtual DOM?
...
### 334. What is the main goal of React Fiber?
...
### 335. Explain conditional rendering in React.
...
### 336. Explain the commit phase vs render phase.
...
### 337. How do you implement a feature flag system?
...
### 338. How do you render Array, Strings and Numbers in React 16 Version?
...
### 339. How does the Virtual DOM improve performance?
...
### 341. How would you implement role-based access control (RBAC) in React?
...
### 343. Key change forcing remount
...
### 345. Should keys be globally unique?
...
### 348. What are the rules covered by diffing algorithm?
...
### 349. What is "key" prop and what is the benefit of using it in arrays of elements?
...
### 352. What is reconciliation? How does React's diffing algorithm work?
...
### 353. What is the `key` prop and why is it important?
...
### 354. What is the impact of indexes as keys?
...
### 355. Why is a component constructor called only once?
...
### 356. How do you set default value for uncontrolled component?
...
### 357. How to focus an input element on page load?
...
### 358. List reorder with stable key vs index key — where does uncontrolled input value go?
...
### 359. What are the differences between controlled and uncontrolled components?
...
### 360. What is the controlled component pattern for reusable components?
...
### 361. Can You Use Multiple Contexts in One Component?
...
### 362. Explain about types of Hooks in React.
...
### 363. Give an example on How to use context?
...
### 365. How do you use contextType?
...
### 366. How does React Context work? When can it hurt performance?
...
### 367. How does useContext works? Explain with an example
...
### 371. What is the Context API? When should you use it instead of prop drilling?
...
### 372. What is the purpose of default value in context?
...
### 373. What is useContext? What are the steps to follow for useContext?
...
### 374. What would the context value be for no matching provider?
...
### 375. Are there any similarities between Redux and RxJS?
...
### 376. Can React Hook replaces Redux?
...
### 377. Can you combine **useReducer** with **useContext**?
...
### 378. Compare Redux, MobX, and Recoil for enterprise-scale state management (pros and cons).
...
### 379. Context vs Redux – when to choose which?
...
### 380. Do I need to keep all my state into Redux? Should I ever use react internal state?
...
### 381. Do you need to have a particular build tool to use Redux?
...
### 382. Explain reducers and extraReducers – when to use each?
...
### 383. Explain the flow of Redux Toolkit.
...
### 384. Explain the Redux data flow (action → reducer → store → view).
...
### 385. Give an example of Reselect usage?
...
### 386. How do you make sure that user remains authenticated on page refresh while using Context API State Management?
...
### 387. How do you manage global state? Compare Context, Redux, and modern alternatives.
...
### 388. How do you pass parent data to the 5th child component?
...
### 389. How does `useReducer` works? Explain with an example
...
### 390. How does Redux Toolkit work internally?
...
### 391. How Redux Form `initialValues` get updated from state?
...
### 392. How Relay is different from Redux?
...
### 393. How to access Redux store outside a component?
...
### 394. How to add multiple middlewares to Redux?
...
### 395. How to dispatch an action on load?
...
### 396. How to make AJAX request in Redux?
...
### 397. How to reset state in Redux?
...
### 398. How to set initial state in Redux?
...
### 399. How to structure Redux top level directories?
...
### 400. How to use `connect()` from React Redux?
...
### 401. How would you design a state management solution for a complex analytics/dashboard app?
...
### 402. Redux vs Context API vs Zustand – how do you decide in a large-scale application?
...
### 403. Should I keep all component's state in Redux store?
...
### 404. Situation: Context is causing performance issues in a large app – what do you do?
...
### 405. What are Redux selectors and why use them?
...
### 406. What are the advantages of formik over redux form library?
...
### 407. What are the core principles of Redux?
...
### 408. What are the differences between `call()` and `put()` in redux-saga?
...
### 409. What are the differences between `redux-saga` and `redux-thunk`?
...
### 410. What are the differences between Flux and Redux?
...
### 411. What are the differences between Redux and MobX?
...
### 412. What are the different ways to write `mapDispatchToProps()`?
...
### 413. What are the downsides of Redux compared to Flux?
...
### 414. What are the features of Redux DevTools?
...
### 415. What are the main features of Redux Form?
...
### 416. What are the main features of Reselect library?
...
### 417. What are typical middleware choices for handling asynchronous calls in Redux?
...
### 418. What is `createSlice()` and what does it contain? (name, initialState, reducers)
...
### 420. What is `useReducer`? Why do you use useReducer?
...
### 421. What is an action in Redux?
...
### 424. What is Jotai and how does the atomic model work?
...
### 426. What is prop drilling and how do you solve it?
...
### 427. What is prop drilling? Problems and solutions.
...
### 429. What is Redux and why is it used?


Redux is a predictable state container: single source of truth (one global store), state is read-only (only changed by dispatching actions), changes via pure reducer functions. Benefits for large apps: predictable state transitions, easy debugging (Redux DevTools time-travel), centralized state logic, middleware for async operations, testable reducers. Redux Toolkit (RTK) is the modern recommended approach — reduces boilerplate with createSlice, createAsyncThunk, and immer-based immutable updates.
...
### 432. What is Redux Toolkit and why is it recommended over plain Redux?
...
### 435. What is reselect and how it works?
...
### 436. What is the `useSelector` / `useDispatch` pattern in Redux?
...
### 437. What is the difference between `mapStateToProps()` and `mapDispatchToProps()`?
...
### 438. What is the difference between component and container in React Redux?
...
### 439. What is the difference between Context API and Redux Toolkit?


Context API: built-in React, no extra library, ideal for low-frequency updates (theme, locale, auth user). Limitation: any context value change re-renders all consumers — bad for high-frequency state. Redux Toolkit: external library, single global store with selectors — components only re-render when their specific slice changes. Better for: complex state, frequent updates, time-travel debugging, multiple teams. Decision: use Context for simple/infrequent state, Redux Toolkit for complex apps with many state updates.
...
### 440. What is the difference between React context and React Redux?
...
### 442. What is the flux architecture pattern?
...
### 443. What is the mental model of redux-saga?
...
### 444. What is the proper way to access Redux store?
...
### 445. What is the purpose of the constants in Redux?
...
### 446. What is the Redux Toolkit (RTK)?
...
### 447. What is the use of the `ownProps` parameter in `mapStateToProps()` and `mapDispatchToProps()`?
...
### 448. What is your favorite React stack?
...
### 449. What is Zustand and how does it differ from Redux?
...
### 450. What problems does Redux solve in large React applications?
...
### 451. Whats the purpose of `at` symbol in the Redux connect decorator?
...
### 452. When should you NOT use Context for state?
...
### 453. Where and why have you used Redux Toolkit in your projects?
...
### 454. Why are Redux state functions called reducers?
...
### 455. How do you programmatically navigate using React Router v4?
...
### 456. How does client-side routing work?
...
### 457. How to add Google Analytics for React Router?
...
### 458. How to get history on React Router v4?
...
### 459. How to get query parameters in React Router v4?
...
### 460. How to implement _default_ or _NotFound_ page?
...
### 461. How to pass params to `history.push` method in React Router v4?
...
### 462. How to perform automatic redirect after login?
...
### 463. What are nested routes in React Router v6?
...
### 465. What are route actions in React Router?
...
### 466. What are route loaders in React Router v6.4+?
...
### 467. What are the `<Router>` components of React Router v6?
...
### 468. What are the benefits of React Router V4?
...
### 469. What are the patterns for data fetching in React?
...
### 470. What is React Router and what are its main components?
...
### 472. What is route based code splitting?
...
### 473. What is routing in React? How does it work?
...
### 474. What is the `Outlet` component?
...
### 475. What is the difference between `Router` and `Link` in React Router?
...
### 476. What is the difference between `useNavigate` and `<Navigate>`?
...
### 477. Why you get "Router may have only one child element" warning?
...
### 478. Are custom DOM attributes supported in React v16?
...
### 479. Batching in React 18 vs React 17
...
### 480. How does React 18's automatic batching work?
...
### 481. How does React Fiber architecture change rendering?
...
### 482. How does React Fiber works? Explain in detail.
...
### 483. How to pretty print JSON with React?
...
### 484. Is it possible to prevent automatic batching?
...
### 485. Is there a functional equivalent of error boundaries?
...
### 486. React 18 automatic batching in a native event handler
...
### 487. Situation: A search input lags as user types – how do you fix it?
...
### 488. Situation: You need to keep the UI responsive during a heavy filter operation on 10k items – how?
...
### 489. useDeferredValue keeping input responsive during an expensive re-render
...
### 490. useTransition keeps UI responsive
...
### 491. useTransition marking a state update as non-urgent
...
### 493. What are React Suspense and React.lazy? How do they enable code splitting?
...
### 494. What are the key features introduced in React 19?
...
### 495. What is `createRoot()` and why was it introduced in React 18?
...
### 496. What is `React.lazy` and how does it work?
...
### 498. What is `useActionState` (React 19)?
...
### 500. What is `useOptimistic` (React 19)?
...
### 502. What is code splitting and how does React.lazy work internally?
...
### 503. What is code splitting at the route level?
...
### 504. What is Concurrent Rendering?
...
### 505. What is concurrent rendering? When does it help vs hurt?
...
### 507. What is global error monitoring in React apps?
...
### 509. What is suspense component?
...
### 511. What is the `useTransition` hook for performance?
...
### 512. What is the behavior of uncaught errors in react 16?
...
### 513. What is the difference between async mode and concurrent mode?
...
### 514. What is the difference between optimistic and pessimistic updates?
...
### 515. What is the use() hook in React 19?
...
### 516. What is the useDeferredValue hook?
...
### 517. What is the useOptimistic hook?
...
### 518. What is the useSyncExternalStore hook?
...
### 519. What is the useTransition hook and how does it differ from useDeferredValue?
...
### 520. Why does strict mode render twice in React?
...
### 521. Difference between CSR, SSR, SSG, and ISR?
...
### 522. Explain React Server Components vs Client Components.
...
### 523. How do you ensure a React app performs well at 100k users?
...
### 524. How does useLayoutEffect work during server-side rendering (SSR)?
...
### 525. How you implement Server Side Rendering or SSR?
...
### 526. Is it good to use `setState()` in `componentWillMount()` method?
...
### 527. Is it possible to use async/await in plain React?
...
### 528. RSC vs SSR – what's the difference?
...
### 529. Situation: API data is needed in multiple components – how do you avoid duplicate fetches?
...
### 530. What are loadable components?
...
### 531. What are Next.js `loading.js` and `error.js`?
...
### 532. What are search params and how do you use them?
...
### 533. What are Server Actions in React 19?
...
### 534. What are the differences between page router and app router in nextjs?
...
### 535. What are useFormState and useFormStatus hooks?
...
### 536. What causes hydration mismatches and how do you fix them?
...
### 537. What is CRA and its benefits?
...
### 538. What is hydration? How do hydration mismatches occur?
...
### 539. What is ISR (Incremental Static Regeneration)?
...
### 540. What is parallel vs sequential data fetching?
...
### 544. What is server-side rendering (SSR)? How does it differ from client-side rendering?
...
### 545. What is SSG (Static Site Generation)?
...
### 547. What is Streaming SSR and how does React 18+ improve it?
...
### 549. What is the 'use client' directive?
...
### 550. What is the difference between React and ReactDOM?
...
### 551. What is the Next.js App Router?
...
### 552. What is the purpose of Suspense beyond lazy loading?
...
### 553. What is the use of `react-dom` package?
...
### 554. When to use client and server components?
...
### 555. Can you describe about componentDidCatch lifecycle method signature?
...
### 556. Design a real-time chat UI in React.
...
### 557. Do Hooks cover all the functionalities provided by the classes?
...
### 558. Error boundary catches what?
...
### 559. How are error boundaries handled in React v15?
...
### 560. How do you create an error boundary?
...
### 561. In which scenarios error boundaries do not catch errors?
...
### 562. Is Hooks cover all use cases for classes?
...
### 563. Situation: A critical bug is in production – what's your process?
...
### 564. Situation: A third-party component throws – how do you handle it?
...
### 566. What are the methods invoked during error handling?
...
### 567. What is the benefit of component stack trace from error boundary?
...
### 568. What is the proper placement for error boundaries?
...
### 569. What is the purpose of getDerivedStateFromError?
...
### 570. Custom hooks vs HOCs vs render props – when to use each?
...
### 571. Do Hooks replace render props and higher order components?
...
### 572. Higher-Order Component (HOC) that logs props on every render
...
### 573. How do you create HOC using render props?
...
### 574. How do you prevent prop explosion in complex components?
...
### 575. How does the performance of using Hooks will differ in comparison with the classes?
...
### 576. How to create props proxy for HOC component?
...
### 577. How to format date using React Intl?
...
### 578. How to use `<FormattedMessage>` as placeholder using React Intl?
...
### 579. Must prop be named as render for render props?
...
### 580. Render props pattern — headless component sharing fetch logic
...
### 581. What are compound components?
...
### 583. What are Higher Order Components?
...
### 584. What are HOC factory implementations?
...
### 585. What are the limitations with HOCs?
...
### 586. What are the problems of using render props with pure components?
...
### 587. What are the sources used for introducing hooks?
...
### 588. What is a hook? Why were hooks introduced?
...
### 589. What is render hijacking in react?
...
### 591. What is the provider pattern?
...
### 592. What is the purpose of displayName class property?
...
### 593. What is the purpose of forward ref in HOCs?
...
### 594. What is the state reducer pattern?
...
### 595. Give a simple example of Jest test case
...
### 596. How do you test user interactions?
...
### 597. How would you implement internationalization (i18n) in React?
...
### 598. What are the advantages of Jest over Jasmine?
...
### 600. What is React Testing Library?
...
### 601. What is Shallow Renderer in React testing?
...
### 602. What is the difference between shallow and deep rendering?
...
### 603. What is the purpose of ReactTestUtils package?
...
### 604. What is the stable release for hooks support?
...
### 605. What is the testing pyramid for React?
...
### 606. `React.FC` vs explicit return type – which is better?
...
### 607. How do you design a reusable button component?
...
### 608. How do you get redux scaffolding using create-react-app?
...
### 609. How do you type `useReducer`?
...
### 610. How do you type `useState` with TypeScript?
...
### 611. How do you type children in React with TypeScript?
...
### 612. How do you type component props with TypeScript?
...
### 613. How is React different from Angular or Vue?
...
### 614. How should you structure a large React application?
...
### 615. How to use TypeScript in `create-react-app` application?
...
### 616. How would you architect a React app for a team of 20 developers?
...
### 617. How would you build a custom hook library?
...
### 618. How would you design a design system in React?
...
### 619. Situation: A dropdown closes when you click inside it – what's likely wrong?
...
### 620. What are the benefits of using TypeScript with ReactJS?
...
### 621. What are the features of create react app?
...
### 622. What are the recommended ways for static type checking?
...
### 623. What is a discriminated union and when is it useful in React?
...
### 624. Why use TypeScript with React?
...
### 625. How do you build a reusable modal?
...
### 626. How do you handle keyboard navigation in custom components?
...
### 627. How would you build a drag-and-drop kanban board?
...
### 628. What are ARIA roles and attributes?
...
### 629. What are headless components?
...
### 630. What are the popular React-specific linters?
...
### 631. What are the RTL query priorities?
...
### 635. What is focus management and why does it matter?
...
### 636. What is the purpose of ESLint and Prettier in a React project?
...
### 637. What is the useId hook and when should you use it?
...
### 638. What is Vitest and how does it differ from Jest?
...
### 639. What tools help check React app accessibility?
...
### 640. Why do React Hooks make use of refs?
...
### 641. Why does accessibility matter in React apps?
...
### 642. Can I use javascript urls in react16.9?
...
### 643. How do you securely store auth tokens in a React app?
...
### 644. How does React prevent XSS by default?
...
### 645. How to use innerHTML in React?
...
### 646. How to use styles in React?
...
### 647. What is `dangerouslySetInnerHTML` and why is it dangerous?
...
### 648. What is a CSRF attack and how do you prevent it in React apps?
...
### 649. Can Redux only be used with React?
...
### 650. How React Router is different from history library?
...
### 651. How to combine multiple inline style objects?
...
### 652. How to debug your React Native?
...
### 653. How to do logging in React Native?
...
### 654. How to test React Native apps?
...
### 655. What is `TestRenderer` package in React?
...
### 657. What is the difference between React Native and React?
...
### 658. Give an example of Styled Components?
...
### 659. How do you do form validation in React without a library?
...
### 660. How do you integrate a non-React library (e.g., D3, Leaflet)?
...
### 661. How do you memoize a component?
...
### 662. How do you use immer library for state updates?
...
### 663. How does ReactJS work behind the scenes?
...
### 664. How to make AJAX call and in which component lifecycle methods should I make an AJAX call?
...
### 665. Is it recommended to use CSS In JS technique in React?
...
### 666. Should I learn ES6 before learning ReactJS?
...
### 667. What are common React performance pitfalls?
...
### 668. What are Styled Components?
...
### 669. What are the common usecases of useRef hook?
...
### 670. What are the differences between useEffect and useLayoutEffect hooks?
...
### 671. What are the limitations of React?
...
### 672. What are the major features of React?
...
### 673. What are the popular packages for animation?
...
### 674. What are the two ways of formatting in React Intl?
...
### 675. What are the use cases of useContext hook?
...
### 676. What are the usecases of useLayoutEffect?
...
### 677. What environment variables are safe to expose in a React app?
...
### 678. What is a monorepo and how does it relate to React projects?
...
### 679. What is bundle analysis and how do you do it?
...
### 682. What is React and what problem does it solve?
...
### 685. What is React Query (TanStack Query)?
...
### 688. What is the 'why did you render' library?
...
### 689. What is the difference between Shadow DOM and Virtual DOM?
...
### 690. What is the popular choice for form handling?
...
### 691. What is the useInsertionEffect hook?
...
### 692. What is the virtual DOM? How does react use the virtual DOM to render the UI?
...
### 693. What is windowing technique?
...
### 694. What is windowing/virtualization and when do you need it?
...
### 695. When do you need to use refs?
...
### 696. Why do you need additional care for component libraries while using forward refs?
...
### 697. Why ReactDOM is separated from React?
...
### 698. Do browsers understand JSX code?
...
### 699. How do you measure and fix excessive re-renders?
...
### 700. How does tree shaking work in modern bundlers?
...
### 701. How to add Bootstrap to a react application?
...
### 702. How to avoid using relative path imports in create-react-app?
...
### 703. How to debug forwardRefs in DevTools?
...
### 704. How to enable production mode in React?
...
### 705. How to ensure hooks followed the rules in your project?
...
### 706. How to set state with a dynamic key name?
...
### 707. How to use https instead of http in create-react-app?
...
### 708. Situation: The app is slow on mobile – how do you diagnose and fix it?
...
### 709. What are the approaches to include polyfills in your `create-react-app`?
...
### 710. What are the best practices for using React Hooks?
...
### 712. What is a CORS issue and how do you handle it?
...
### 714. What is JSX and how is it rendered in the browser?
...
### 717. What is the purpose of eslint plugin for hooks?
...
### 718. What is the React DevTools and what can you do with it?
...
### 719. What is the role of Babel in a React project?
...
### 720. What is the useDebugValue hook?
...
### 722. What is Vite and why is it preferred over CRA?
...
### 723. Why is DevTools not loading in Chrome for local files?
...
### 724. Why React tab is not showing up in DevTools?
...
### 725. Fix a `useEffect` that has missing dependencies (the ESLint exhaustive-deps warning)
...
### 726. Given a slow React tree, how do you identify and fix the performance bottleneck?
...
### 727. Why React.js? What problems does it solve?
...
### 728. `getBy` vs `queryBy` vs `findBy` – when do you use each?
...
### 729. Can you list down top websites or applications using react as front end framework?
...
### 730. Explain Strict Mode in React.
...
### 731. How do you pass arguments to an event handler?
...
### 732. How do you test async behavior (e.g., API calls)?
...
### 733. How do you type event handlers?
...
### 734. How do you update rendered elements?
...
### 735. How to prevent a function from being called multiple times?
...
### 736. What are capture phase events?
...
### 737. What are the advantages of React over Vue.js?
...
### 738. What are the common folder structures for React?
...
### 739. What are the conditions to safely use the index as a key?
...
### 740. What are the drawbacks of MVW pattern?
...
### 741. What are the main features of React Intl?
...
### 742. What are the Pointer Events supported in React?
...
### 743. What happened to event pooling?
...
### 744. What happens if you use useLayoutEffect for non-layout logic?
...
### 745. What is a React SPA and what are its trade-offs?
...
### 748. What is Mock Service Worker (MSW)?
...
### 749. What is optimistic mutation in React Query?
...
### 751. What is the browser support for react applications?
...
### 752. What is the difference between React and Angular?
...
### 753. What is the history behind React evolution?
...
### 754. What is the purpose of `push()` and `replace()` methods of `history`?
...
### 755. What is the purpose of registerServiceWorker in React?
...
### 756. What is the purpose of renderToNodeStream method?
...
### 757. Why avoid array index as key?
...
### 758. Why fragments are better than container divs?
